...
- Modernized the public repository surface: complete community-health files,
  ...
  signaling, and current 1.x architecture and API documentation. Local
  assistant configuration and an obsolete pre-1.0 manifest are no longer
  tracked as public project source.
