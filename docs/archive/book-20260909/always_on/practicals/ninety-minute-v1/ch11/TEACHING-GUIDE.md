...
Unit A: **Construct tool isolation**. Unit B: **Break, repair and transfer tool isolation**. Allocate ninety minutes to each,
...
The additional task is **Separate registration, permission and consequential authority**:
...
**Surviving limitation:** Dispatcher admission is not OS or network containment; container execution remains a separate chapter experiment.
