...
|---|---|---|---|
| A · 90 min | Construct bounded delegation | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer bounded delegation | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch14-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch14-instructor-pack-v1.zip) ·
