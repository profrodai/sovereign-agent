...
|---|---|---|---|
| A · 90 min | Construct durable memory | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer durable memory | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch04-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch04-instructor-pack-v1.zip) ·
