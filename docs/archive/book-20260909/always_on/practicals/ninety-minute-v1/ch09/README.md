...
|---|---|---|---|
| A · 90 min | Build durable intent and evidence | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Survive the ambiguous order | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch09-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch09-instructor-pack-v1.zip) ·
