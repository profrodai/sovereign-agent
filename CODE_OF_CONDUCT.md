...
the repository's
[private reporting form](https://github.com/profrodai/sovereign-agent/security/advisories/new).
Begin the report title with `Code of conduct:` so maintainers can route it
without exposing the reporter or the subject publicly. Do not file conduct
