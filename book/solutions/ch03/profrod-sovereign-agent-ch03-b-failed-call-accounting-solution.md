...
jupyter:
  ...
  course:
    ...
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch03-b-failed-call-accounting-solution
...
if LEARNER_HANDOFF is not None:
    ...
    reference_encoded = (
        ...
        "9=_nj4DOiHT#AH?wS;#O_-{fuc^i1%d^TG`1ZT64^F^HCo#%O8#@1*`axLYpuUJkEzhlAB0{|!#yW_Id"
        "5Lq>Y^gi<g`^2b6$AUkp2k9o`%14<&Lsra`O1O0nPz74<YvcIfH8k4XJ8Ldzo*$B1+Yxx4mu_fbm^y{1"
        "HJjky*EGMUk2;a!b<U^~OubGw$ESnhkp$jS%KVJxIYdwkxFR)?th|itf|_*0RFC7j<aw4DDRWI$eoJ3`"
        "m|c=p;1!As;}gda!j(=pY)h}mx)iD5QjpaZ5p>JQ3f5AAdkkDat8d_l+7DKN=h-;Jh0ItUD<zdbFNNV-"
        "W^d}KU@CatKbpMo*Gm4EiD;=x7IZ}{OC{VpsT76@GX!mLg@iaN&2v2jQx-Xc2>igaWK4-I)0*BeU$cB2"
        "v>~a;5WyFsWX{MC2-TWvLxmwBkV+950=_w@Zl4+fd|f@TsvB}g_LX&KVj0K^BDm^t;qS{H1%HHRWN6nk"
        ";8}Q>#XJ_)<|aVT@HNke&nUB8Hnf#WybhmdrRt{KGGR0sT09tJ<+jkieYJTOf|kl8x9m~7U>+9uv`>E8"
        "qhP+Fbj-Ha<2|<3ZmCug@ajCAvm&RDHkF1=W+Vw0+$4!jjS%of-N_KE%Mu|1ZkX~NN1Ixy+!i@AtP)Tu"
        ")gjn2>WJ!rOvg;Y9*p1WX%UA#q^vNoFtQjMrYJ^mM*`)Vb?b|)`GYAH1NN|?r8X=h0a%=!N`ao3UB=V#"
        "^w(thaXwu%+1Qkqji8SF8cTehMMN8!-X5Kh5HKqul5=emOC%vQ(T=`61z}LdxE0vgTS@NO->BJ(H|ot4"
        "U7Mr3Mz6h3q{^7;D<=B3#4=d?_VMWV(R4hSjIenBQ&M5Lc_c&lsh?3hnfN_s=$DzXSk6bEeu?Mv&pVd9"
        "eby2e_&o=bbJVB7NJDct{pt7^Qq%_@7v}?*N+?Q|Zm4E(Pc>|5#s(w^y_MSwGnVp<B{bV|jr*vdQeE$d"
        "d<}SaMM}-G2BF?X6?ID=YT|IWw8+KmJf0+Hqsb(hj4#GZ(wC?UM9mevs_rqzlT>P?y{l-~Wp=~NSA@?N"
        "%dYVHDJmtN_xpG;{$&y;XQM^jX0rdKyP6>!htOHb5Z;7P8Rwq0h7I8~gxV;~n6Oe+MWjuR9Tjh0pyGH("
        "MI&?Hp<y>2o>hMG73F{X#`^Y@w+`<se}T@o-|f>?)vetqx|5(H;~6z9w0Tk^sFL>x!B-CDaXS#@_L`{>"
        "Y)Xf~9txHkmIb&)Fi~z1F`0d+LpbSTdRY`XXBqZJvUnV1j1_p{YU6plme-o8JNI5~q+bi$gYDS<<5B?C"
        "z!06Em4@56Z&`vtk|4??Nm~^1UJqzdFp>4~X@4gtxBxP&J+uG3_7NF2?mEC#TSkVBkq5Z6p{B&}lgrU!"
        "L9q7QB}I*Vpd#yd+<^<QTr(i=N8`y(%ks1XhjrI2@3Bd|<C<UREKy9Cxxswc&7NJn3!#S-K?56TbbJmG"
        "Anq%9e^oDNg+^9u!ZcIz9y4l3b=@p?nx7qx5V**gFwtqybk>b6v*~g^I$Pr2;0&?;+p*0#X&T4pi{#U6"
        "{u>F}^Gz;g;nHD?JB8~ulC}>=?c8vhCv8L0amrsqXeu~*8`{m;mTYtyf~(i)XRoRmqo~lS;)U6(m|Z17"
        "YmyTV5ga=qO&8pdEM~NKj0uQ9GgBSP?l(MVfQ@5YI2c}B0miL~`M0W~2VNc94kUFK)|%@>$zQ>p{eR$j"
        "7XlmK9^h-B(OrDK7OEY#@xfoB3QZ5Tm0!M6vbBgq9;hNohMl+{;%oi*O|N!NK*LTV90Dk9_?8-sS9Q8L"
        ";NjLU-9&p8!AT48Hnm<wt@EFUb?dFj$r?1>d_T`yR|I>d)*gBH_JFoCe{qPaJsBY~J|{nVpg1BSUvsAH"
        "CSILtd#5_|h&$D-y4jvH;dkB+Fzb<qIMJmCfD;ME#DELKlxFt8+hcio4Ce7=JX*%*t}h$^_;IifDhu1W"
        "bY0V_j(Q1o&tc<I&rgCL5(#NKVSBlI&t?~wlXzL}eom5`une?Oyzql+4~#D^m!Fe)d^!32gNDFOO@zK@"
        "3gvZ{`dp|E*TxQXwVP@W{#*dC4Z-em2d=odlef&C^n<>%z1V;6sH&cwp{nO*P>rq0cMP`Lxm%~fax40d"
        "snX67+w;8fbi5poCdoy-Sd4z{oEO`<pMKPaZTmw%@=-IelMXk{0V8pWTu{Zpjsf%lrtFTX<`6z0)w!w_"
        "TxvTg=!*Tcp#}tFnFc#Y;Ns@*_~Ob-r4X)fj@-y*uPtmQpbcNYAH-j0(&hIiJ{@Oudc}se>!z^Rc=h^f"
        "ukA}*bK6+dcG4kqh~47rKj{ugyArRO5vp~i8#>n`TP}LSYXn$T5~?o<2aK}qeTzI@ZvW-xqBQ&@@h0#P"
        "s)il&$=Pf=jn9_j*)*BXmdQLGoqvWu|Mv%A2646TQ!pE5zc2v3p<E2G;UCSH<M*SpWpX)MeyF}&_$1vN"
        "zd0%eH%IhnLq#Un>!Z7q0Tv4hJgN*|(-envxMrM?qXD1h<K;4*63nSKf4H_dj>+b%XCjrEO|0%@x8`q;"
        "HG72!uYmkZIFI(s9^5N#SYmL{SxFC_8ZK@kQkwPA&!mdmzUhtGt!sPI4|x8=XnH<-|32xiI`BO9z*NdL"
        "9?|T_rl`U*f}X^>v~Hypf)Q#A+ZOJ)d{WWs{t#)Xs$ZK`d66~cdBcL<J<O(Wc~Mxt<3_x7vm4cSkA`i$"
        "s#9T|P_?mD7Leht3q$XzK7PjkjOS-#{8|=Y&gRRAz^iVIcigiV-{Ajsn*)F"
    )
...
def repair_fragment():
    return "exposure += limits.estimated_call_cents"
```
...
try:
    ...
    assert original_probe.count("estimated_call_cents=5") == 1
    hidden_lab.probe.write_text(
        original_probe.replace("estimated_call_cents=5", "estimated_call_cents=7"),
        encoding="utf-8",
    )
    ...
    hidden_result = hidden_lab.run(
        "HIDDEN_REPAIR",
        expected={"estimated_cents": 7, "model_calls": 1, "stop_reason": "MODEL_FAILED"},
    )
finally:
    hidden_lab.close()
