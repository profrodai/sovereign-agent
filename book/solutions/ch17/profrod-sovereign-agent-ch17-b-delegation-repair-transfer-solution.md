...
jupyter:
  ...
  course:
    ...
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch17-b-delegation-repair-transfer-solution
...
# Instructor holdout appended to a submitted Chapter 14 Unit B.
...
try:
    ...
    task.close()
print("HOLDOUT_RESULT=" + json.dumps({"unit": "ch17-b", "status": "PASSED"}, sort_keys=True))
```
