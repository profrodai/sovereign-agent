...
jupyter:
  ...
  course:
    ...
    lesson_id: operation
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch18-b-operations-repair-transfer-solution
...
try:
    ...
    task.close()
print("HOLDOUT_RESULT=" + json.dumps({"unit": "ch18-b", "status": "PASSED"}, sort_keys=True))
```
