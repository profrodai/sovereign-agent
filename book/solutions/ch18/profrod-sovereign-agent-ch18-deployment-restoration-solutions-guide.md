...
|---|---|---|---|
| A · 90 minutes | [A: deployment restoration](profrod-sovereign-agent-ch18-a-deployment-restoration-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch18-a-deployment-restoration-solution.md) | Construct, connect and explain |
| B · 90 minutes | [B: operations repair transfer](profrod-sovereign-agent-ch18-b-operations-repair-transfer-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch18-b-operations-repair-transfer-solution.md) | Diagnose, repair and transfer |
