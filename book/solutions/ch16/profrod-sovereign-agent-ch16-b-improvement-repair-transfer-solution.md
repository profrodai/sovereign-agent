...
jupyter:
  ...
  course:
    ...
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch16-b-improvement-repair-transfer-solution
...
try:
    ...
    task.close()
print("HOLDOUT_RESULT=" + json.dumps({"unit": "ch16-b", "status": "PASSED"}, sort_keys=True))
```
