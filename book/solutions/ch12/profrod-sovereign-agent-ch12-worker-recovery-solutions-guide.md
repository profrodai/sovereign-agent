...
|---|---|---|---|
| A · 90 minutes | [A: worker crash recovery](profrod-sovereign-agent-ch12-a-worker-crash-recovery-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch12-a-worker-crash-recovery-solution.md) | Construct, connect and explain |
| B · 90 minutes | [B: recovery repair transfer](profrod-sovereign-agent-ch12-b-recovery-repair-transfer-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch12-b-recovery-repair-transfer-solution.md) | Diagnose, repair and transfer |
