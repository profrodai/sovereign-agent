...
|---|---|---|---|
| A · 90 minutes | [A: durable order evidence](profrod-sovereign-agent-ch11-a-durable-order-evidence-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch11-a-durable-order-evidence-solution.md) | Construct, connect and explain |
| B · 90 minutes | [B: ambiguous order recovery](profrod-sovereign-agent-ch11-b-ambiguous-order-recovery-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch11-b-ambiguous-order-recovery-solution.md) | Diagnose, repair and transfer |
