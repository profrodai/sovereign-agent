...
|---|---|---|---|
| A · 90 minutes | [A: tool isolation](profrod-sovereign-agent-ch14-a-tool-isolation-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch14-a-tool-isolation-solution.md) | Construct, connect and explain |
| B · 90 minutes | [B: isolation repair transfer](profrod-sovereign-agent-ch14-b-isolation-repair-transfer-solution.ipynb) | [Markdown](profrod-sovereign-agent-ch14-b-isolation-repair-transfer-solution.md) | Diagnose, repair and transfer |
