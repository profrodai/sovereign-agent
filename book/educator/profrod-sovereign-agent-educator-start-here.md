...
| 4 | [Build durable SQLite state](ch04/profrod-sovereign-agent-ch04-sqlite-state-educator-guide.md) | PLANNED — brief only |
...
| 7 | [Build a durable work inbox and report outbox](ch07/profrod-sovereign-agent-ch07-durable-inbox-outbox-educator-guide.md) | PLANNED — brief only |
