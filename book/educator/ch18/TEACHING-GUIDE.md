...
The additional task is **Validate every member of a restore manifest**:
...
**Surviving limitation:** No host reboot or external supplier reconciliation is proved by this local exercise.
