...
jupyter:
  ...
  course:
    ...
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch02-b-pydantic-validation-repair-solution
...
# Instructor holdout appended to a submitted Chapter 2 Unit B.
...
try:
    ...
    task.close()
print("HOLDOUT_RESULT=" + json.dumps({"unit": "ch02-b", "status": "PASSED"}, sort_keys=True))
```
