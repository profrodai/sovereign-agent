...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/profrodai/sovereign-agent/blob/main/book/exercises/ch03/profrod-sovereign-agent-ch03-a-bounded-agent-loop-exercise.ipynb) Runs on Google Colab as it ships today, or on any local Python 3.12+ kernel.
...
The setup above supplies the required source; it runs on Google Colab or any Python 3.12+ kernel. It uses authored model turns and makes no network call or purchase.
...
OPENING_TURNS = [
    ...
    ModelTurn("Drafts total 2600 cents USD. No purchase was made."),
]
```
...
def fresh_drafts_path(label):
    ...
    path = COURSE_WORK / f"ch03-a-llm-drafts-{label}.json"
...
RECORDED_TURNS = [
    ...
    scripted_turn(
        "Drafted 6 vanilla at 250 cents, 1500 cents in total. Strawberry needs 4 at 275 cents, 1100 cents, which "
        "would take drafts to 2600 cents against a 2500 cents budget, so it was refused and needs Lucy's "
...
llm_report_path = COURSE_WORK / "ch03-a-llm-lab-report-v1.json"
