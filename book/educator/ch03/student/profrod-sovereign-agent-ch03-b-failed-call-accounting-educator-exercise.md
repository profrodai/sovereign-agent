...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/profrodai/sovereign-agent/blob/main/book/exercises/ch03/profrod-sovereign-agent-ch03-b-failed-call-accounting-exercise.ipynb) Runs on Google Colab as it ships today, or on any local Python 3.12+ kernel.
...
Suppose each model attempt has a configured exposure of two cents and the budget is six.
...
if LEARNER_HANDOFF is not None:
    ...
    reference_encoded = (
        "c-qxj-EP}D628|{%<@XwDsGZ?4-O2dyFQ6}Y8=N7Z1;4FtRXNG9djd-T9V4o76JAl&J&&|Sq!OP+i9E2"
        "`XZ4=qnY9Sd>oGWwvfs|DvL*tyX${zDe7yf>nl}?mPJ2mZ>{7OGHPg=Q>~eX>RCf_90fI-oL|>ZFR9sh"
        "9=_nj4DOiHT#AH?wS;#O_-{fuISo8-KASBeg0tDj`65p6&htDkV{0@ext8+QS1hN7-?3om0RR+=-EmoJ"
        "h^(4HdY}1$ePYz3W5J))gLIQ|<)h4?AuDD|CEPj(r~)nbwQ+p#8X9fxoi!IU&kxD1?Fc;2OE<JIOr1j1"
        "noaQUYntEFN1aIVI%iY~re3F;<I_R$NCIyuWqwBU93rR%T#=ecR$j(+K~1`0s>g9%@;pn7l({A=zojoe"
        "%r40)@CwC+@rh#y;Yz0)wxw5OU5eCjDah)I2)bot1#79mJq9kI)i-cN?FXyC^K6{qLS`(Fm6FPzm%{KZ"
        "vp02AFcm!SA5C8PYbF27M6^^T3%Vkfr4sI)R0_j{8G<&rLP8vs=D8k%DT|yz1b*OIGN#0qX-#jKuUWnh"
        "+K^Oah~NuRGG}B6glf&Tp~8?5NTrAj0pA={w@-}#zOEiv)eX5L`^vgAu?%Dd5nT1S@b_hpf<MADGPG+N"
        "@GLycVjc@?a}%Iv_?qX#XOvkk8`?@GUWd=KQgu^qnJ}6REglTAa$9KMzS=wsK}%(lTlT13Fb@lS+9yBl"
        "Q83?7I%Zqz@gCc1w^XYLcy%7mS&`F6n@YnbGm?Z0Zj!{NMhN(#?qrD7Wr+|0H%$4CqfM<;Zi}25Rtcz-"
        ">JV%hbwu?*remgH55{lxw1~qVQdSsP7+H)BQxqe(BY|?wy7fiY{K1rp0ejfcQX7_$04&Z<r9e;2F5~HV"
        "`fIZMIG-+>Y;4NQMo>q7jU_(MBBG5<Z;wt$2$&TS$+<R(C6W-DXh&b3f-tCJ+zM>$tt9vCZ`AC?8}(+2"
        "uFcV1qu1UiQe{l_6%&11Vi_!c`*`&GXgZ!uMp(T6DXB2rJdz>&)X%7$O#B`*^vldxEa#(7zr^$T=N(Jl"
        "K5K~!{GJ2JIqK73q@g*S{&ai{De8ldi}L|YB^0GfH&ipYry902V*?U|-pcKT8B2M_5}Iwf#(mUJsjl}!"
        "z6QLzBBf?ogHZ3Hin^r_HF3CGTI6DO9#4|9(PWZL#uwuy=}XiFqUH)-Rri?VNh&qc-c_{gGP_~sE5c`s"
        "WmkCp6qORs`+d9^|1yb_v(X}MGui*rUCj`VL+C7I2ya5DjC0Rg!-jAgLTwagOjxO^BGM+uj*2%gP;tDY"
        "qLI1p(6E~h&niFpit@jGV|{zdTZi|Rzd+~P@Am1c>eg-)-APc9@r)W4+B~TdRLOgU;46pnxE+Xcd(Bh`"
        "Hl;&g4+TpN%L3dYm?*c1n9M%ZA)ItEy)25HvkZG9Sv(Fh#tOV}wedV&%WKWloqMk~(yxW>!FFu_aVdam"
        "V2IAoO2cj3w=BURNf2d{q%8`0uLra!n8^D0w7-)RTmTu?p4oq1`-lu1cOBrWEhEFm$OBy3P*Y;~$>nIV"
        "AXxkDlA=aFP?2>!?!X0Dt{IT`qw!>?WqI0x!@BF1_t+%fam}xDmMEsn++aTJX3s9(h0w!^pn(lEIzER8"
        "5cie5zp59sLL;j+VVWs<j~TV2x^9*`&Cd=;2wY@LnCLWUI_t)k*>pJ{oh@;1aE4g_?bzm=G>zl)Me=Dj"
        "|BVFg`6idLaOtqcox*h+N!y2`c5XP$leQu0IOVS)G!-1Z4ejP^OEx+U!PRT@vscxOQB>$u@xts?%&wB4"
        "HOUEw2#%eQrVDOJ7BkvA#soy5nW+wC_Zyxwz{asH91Jh60OQug{99Gg1Fw#42a>uAYt8kc<geh){y*@%"
        "3xSPq5AZe6=q|oq3)K$W_~0*5g{BAF$}e9j*;>RQ4^)vP!%o}}@wI;ZrdK;BpkXHw4gr)ld`k_+t2$jA"
        "@NnywZlb-4;G~6kn_91;*7?uFy7gA%WDS~bzMto<D}udJYmdBpdqCTnzc@tIo{SI~pOYUwP#lqvuQ^k8"
        "6R%FSy;B`}#GUF^-E7a9@H=k@nDt0QoaoX6z=;H7V!(xAN;7-l?XkQ(2J`qb9xdZ@*O!fd{5V(#m4)qG"
        "x~}O|N4<o)=df|9=O;lAiG(zru)W;9XS0jTNxZCfKPSmeSO(fCUid+^2gVnd%g@O?zMOpiK||oCCPLpc"
        "h4MN}eJ)goYhwqx+D)|we=Y#nhG2KO16N$!$y;Vm`axgXUhKbjR8`N;P}OrYsK(ahI|f_r+^y4KxfOlK"
        "RB7jk?RnmKI$n-PljI^^EJnX}&Wr8bPd{qIw*8?W`KTG#Nr#)}fRQ*wE~sK)#{hZ&Q+CHxa|j=h>Ri<d"
        "F0~yLbj5z!Py>RoOoN>xaB=f@d~xNaQV7>KM{Z=Z*A_Mt(1x$y58|&g>GFFMpN_LSy<$V#byL`Dyn21L"
        "*Y+i@xos?JJLwQQ#BTBRpL7SLU5QuC2-UjM4V~+eEf+oEH3F<E3Dp;b14h~QzD1rcxBqf;Q5t@dcoTRC"
        "Rl|<?<ZL#b#%Ig%Y?@4G%VZvp&OgJS|N8?lgSguFDVPnjUl@SiP%Z}8@Q>!p@%z!)GPxWrKU7~Xe3EXC"
        "-yD^Kn<IL(p(2y(_0iqQ0E>kL9#w{~X^KNSTr*C{(ST3$@p2hY3FcIrKU`ZJ$7FNXGm*;7CRTT{Tl2Ta"
        "n!Q4VS3v$HoJV_R5AGE=EHOCftfYrd4Hq{NDb4!mXHvy&-}J`p*0nw92R#2_G(Dfaf1h+$9e5slU@GMr"
        "k7)K|Q&iy@K~G{`TDQ^)!3Z^mZ3}l?KB;JRe~2_x)vwK}yvUmJykSA_9%j?GyeKT+aU<Tk*^TPEN5eK="
        ")v2&fsM^>n3&?QSg`xLUA3x)N#`Ci=el3eHXY*x5;8i!qJMP(wZ}5LUtpk1"
    )
...
Predict the baseline observation. If the provider fails after admission, should the local result record zero or one model attempt? Should the configured five-cents exposure disappear?
...
The broken source changes `exposure += limits.estimated_call_cents` to `exposure += 0`. The model-call counter still advances. This separates attempted calls from configured cost exposure and makes repeated failures look free.
...
Compare `baseline["observation"]` with `broken["observation"]`. Only `estimated_cents` should change.

</details>

<details><summary>Hint 3 — the structure</summary>

The replacement adds `limits.estimated_call_cents` to `exposure` before `model.complete` begins.
...
failed = run_loop(
    ...
    dispatcher,
    chapter3["messages"],
    limits=Limits(estimated_call_cents=5, model_budget_cents=10),
)
print("repeated", repeated.status, repeated.model_calls, repeated.tool_calls)
print("failed", failed.status, failed.model_calls, failed.estimated_cost_cents)
assert repeated.status == "REPEATED_CALL_ID"
assert (failed.status, failed.model_calls, failed.estimated_cost_cents) == ("MODEL_FAILED", 1, 5)
```
...
## Extension: put a language model behind your bounded loop

Every turn the loop above consumed was authored: `ReplayModel` handed back turns you wrote, and
the admission decision you constructed counted them against `Limits`. Admission runs *before*
every attempt because, in production, the model is a metered service that keeps asking for
tools for as long as you keep paying. This closing section puts a real model behind the same
loop and makes the budget visible.

The loop is the runtime's `agent_loop.run_loop`, the same construction as yours: call limit
first, then estimated cost exposure, then the attempt; a turn's tool calls are counted against
`tool_calls` before any of them runs; every observation is appended under its `tool_call_id`.
The tools are the Chapter 2 shop tools, rebuilt on the runtime's `Dispatcher` with one rule
added in the chapter's own shape. Drafts are calculations, not purchases, but they add up, so
`draft_order` is marked consequential and its `before_write` gate admits a draft only while
reserved cents plus this draft's cost stays within a draft budget, equality allowed. That is
your transfer task's decision, applied to money instead of model calls.

`llm_lab.py` supplies two models for the loop's `Model` protocol. `ScriptedModel` replays turns
written down here, so the section runs identically for everyone; `OpenAIModel` calls a hosted
model when a key is present. The loop cannot tell them apart; the record says which one ran.

**Prediction:** the next cell prints four schemas and the limits. Write down which tool is
consequential, what the vanilla and strawberry drafts cost together from `PRICES`, and whether
`MODEL_COST_LIMIT` can fire before `MODEL_CALL_LIMIT` at 2 cents per call against 20 cents.
...
from sovereign_agent.files import write_json
...
# The learner module loads the Chapter 2 tools relative to the runtime root.
with contextlib.chdir(COURSE_ROOT):
    chapter_three = run_path(str(COURSE_ROOT / "book/always_on/learner/ch03.py"))
shop_tools = chapter_three["shop_tools"]
SHOP, PRICES = shop_tools["SHOP"], shop_tools["PRICES"]
DRAFT_BUDGET_CENTS = 2500
BASE_LIMITS = {
    "model_calls": 8,
    "tool_calls": 16,
    "seconds": 120,
    "output_tokens": 4096,
    "total_output_tokens": 16_384,
    "estimated_call_cents": 2,
    "model_budget_cents": 20,
}
LOOP_LIMITS = Limits(**BASE_LIMITS)


def fresh_drafts_path(label):
    """The drafts file is the only durable state here; start every run without one."""
    path = COURSE_WORK / f"ch03-b-llm-drafts-{label}.json"
    path.unlink(missing_ok=True)
    return path


def build_loop_tools(shop, drafts_path):
    """The Chapter 2 handlers, unchanged, behind a draft budget in the chapter's shape."""
    reference = shop_tools["build_tools"](shop)
    handlers = {name: tool.handler for name, tool in reference.tools.items()}
    ledger = {"reserved_cents": 0, "drafts": [], "refusals": []}

    def budget(_):
        reserved = ledger["reserved_cents"]
        return {
            "budget_cents": DRAFT_BUDGET_CENTS,
            "reserved_cents": reserved,
            "remaining_cents": DRAFT_BUDGET_CENTS - reserved,
        }

    def admit_draft(call):
        # Admission asks whether this draft may begin; equality at the boundary is allowed.
        cost = PRICES.get(call.arguments["sku"], 0) * call.arguments["quantity"]
        exposure = ledger["reserved_cents"] + cost
        if exposure > DRAFT_BUDGET_CENTS:
            ledger["refusals"].append(
                {"call": call.id, "reason": "DRAFT_COST_LIMIT", "exposure_cents": exposure}
            )
            raise ValueError("draft would exceed the draft budget")

    def draft(args):
        value = handlers["draft_order"](args)  # quantity must equal need, or ValueError
        ledger["reserved_cents"] += value["total_cents"]
        ledger["drafts"].append(value)
        write_json(drafts_path, budget(None) | {"drafts": ledger["drafts"]})
        return value

    no_arguments, product, draft_arguments = (
        shop_tools["NoArguments"],
        shop_tools["ProductArguments"],
        shop_tools["DraftArguments"],
    )
    registered = [
        ExecutableTool("list_stock", "Read stock and need.", no_arguments, handlers["list_stock"]),
        ExecutableTool("supplier", "Read supplier price in cents.", product, handlers["supplier"]),
        ExecutableTool("draft_budget", "Read the draft budget and reserved.", no_arguments, budget),
        ExecutableTool(
            "draft_order",
            "Calculate a draft against the draft budget; never purchases.",
            draft_arguments,
            draft,
            consequential=True,
        ),
    ]
    allowed = frozenset(tool.name for tool in registered)
    return Dispatcher(registered, allowed=allowed, before_write=admit_draft), ledger


scripted_drafts_path = fresh_drafts_path("scripted")
loop_dispatcher, loop_ledger = build_loop_tools(SHOP, scripted_drafts_path)
for tool_schema in loop_dispatcher.schemas():
    function = tool_schema["function"]
    print(function["name"], "requires", function["parameters"].get("required", []))
    print("   ", function["description"])
shop_need = {row["sku"]: max(0, row["reorder_point"] - row["on_hand"]) for row in SHOP["products"]}
print("Need per product:", shop_need, "| prices:", PRICES)
print("Draft budget:", DRAFT_BUDGET_CENTS, "cents | loop limits:", LOOP_LIMITS)
LOOP_MESSAGES = [
    {
        "role": "system",
        "content": (
            "Help Lucy prepare replenishment drafts. First call list_stock. For each product "
            "with needed > 0, call draft_order with exactly that quantity; do not draft products "
            "with needed = 0. Drafts count against a draft budget in USD cents. If a draft is "
            "refused, call draft_budget and say what could not be drafted. Drafts are proposals, "
            "never purchases. Finish with a short summary in USD cents."
        ),
    },
    {
        "role": "user",
...
The four schemas are the Chapter 2 argument classes, `strict=True` and `extra="forbid"`
included, in the `{"type": "function", ...}` envelope the API expects. `LOOP_LIMITS` is what
your admission decision reads: eight model calls, sixteen tool calls, and 2 cents of estimated
exposure per call against a 20 cents budget. Eight calls cost 16 cents, so with these numbers
the call limit always wins; the challenge below changes that.
...
estimated exposure in cents. Which draft is refused, and what does the drafts file hold? Recall
that `Dispatcher.invoke` flattens every refusal to `tool_failed`, so the gate keeps its own
ledger with the exposure that was refused.

The cell then runs *your* Chapter 3 `run_loop` on the same script, with the same dispatcher and
limits. The runtime's loop and yours must agree on every count and every observation; if they
do not, the disagreement is a finding about one of the two loops, not about the model.
...
RECORDED_TURNS = [
    ...
    scripted_turn(
        calls=[
            ...
            {"name": "supplier", "arguments": {"sku": "SKU-STRAWBERRY"}},
        ]
    ),
    scripted_turn(
        calls=[
...
scripted_result = run_loop(
    ScriptedModel(RECORDED_TURNS), loop_dispatcher, LOOP_MESSAGES, limits=LOOP_LIMITS
)
print(describe(scripted_result, "scripted"))
print("Estimated exposure:", scripted_result.estimated_cost_cents, "cents")
print("Gate ledger:", loop_ledger["refusals"])
scripted_trace = tool_trace(scripted_result)
assert scripted_result.status == "COMPLETED"
assert (scripted_result.model_calls, scripted_result.tool_calls) == (5, 6)
assert scripted_result.estimated_cost_cents == 5 * 2
assert [step["ok"] for step in scripted_trace] == [True, True, True, True, False, True]
assert scripted_trace[4]["result"] == "tool_failed"
assert loop_ledger["refusals"] == [
    {"call": "scripted-3-call-2", "reason": "DRAFT_COST_LIMIT", "exposure_cents": 2600}
]
assert scripted_trace[5]["result"]["remaining_cents"] == DRAFT_BUDGET_CENTS - 1500
scripted_drafts = json.loads(scripted_drafts_path.read_text(encoding="utf-8"))
print("Drafts file:", scripted_drafts)
assert [d["sku"] for d in scripted_drafts["drafts"]] == ["SKU-VANILLA"]
assert scripted_drafts["reserved_cents"] == 1500
# Every observation in the transcript carries the identifier of the request it answers.
assert all(m.get("tool_call_id") for m in scripted_result.messages if m["role"] == "tool")

# Your own Chapter 3 loop, on the same script and a fresh dispatcher, must agree exactly.
own_dispatcher, own_ledger = build_loop_tools(SHOP, fresh_drafts_path("own-loop"))
own_result = chapter_three["run_loop"](
    ScriptedModel(RECORDED_TURNS),
    own_dispatcher,
    LOOP_MESSAGES,
    limits=chapter_three["Limits"](**BASE_LIMITS),
)
own_counts = (own_result.status, own_result.model_calls, own_result.tool_calls)
own_counts += (own_result.estimated_cost_cents,)
print("Your loop:", own_counts)
assert own_counts == ("COMPLETED", 5, 6, 10)
assert tool_trace(own_result) == scripted_trace
assert own_ledger["refusals"] == loop_ledger["refusals"]
```

The refused draft is an ordinary failed observation; the loop carries on, and the drafts file
holds only what the gate admitted. Both loops produced the same six observations under the same
identifiers: nothing in the runtime's loop is unexplained by your admission decision.
...
receives the same four schemas and the same system message. It may draft strawberry first, skip
the supplier, or never read the budget; what it cannot do is draft a quantity the shop does not
need, or push reserved drafts past 2500 cents, because those rules live in the handler and the
gate. The two drafts together cost 2600 cents, so at most one of them can succeed.

**Prediction:** write down which draft a careful assistant would make first, and what it should
say about the other. Then run the cell and compare the model's judgment, or the recorded
transcript when the run is scripted, with your prediction. The loop charges 2 cents for every attempt it admits, whether or not the
model used it well.
...
live_drafts_path = fresh_drafts_path("live")
live_dispatcher, live_ledger = build_loop_tools(SHOP, live_drafts_path)
...
live_result = run_loop(chosen_model, live_dispatcher, LOOP_MESSAGES, limits=LOOP_LIMITS)
print(describe(live_result, chosen_model.source))
print("Estimated exposure:", live_result.estimated_cost_cents, "cents")
print("Gate ledger:", live_ledger["refusals"])
live_trace = tool_trace(live_result)
assert live_result.status in {
    "COMPLETED",
    "MODEL_CALL_LIMIT",
    "MODEL_COST_LIMIT",
    "TOOL_LIMIT",
...
# The loop's accounting holds whatever the model did.
assert live_result.model_calls <= LOOP_LIMITS.model_calls
assert live_result.estimated_cost_cents == 2 * live_result.model_calls
assert live_result.estimated_cost_cents <= LOOP_LIMITS.model_budget_cents
assert live_result.tool_calls == sum(1 for m in live_result.messages if m["role"] == "tool")
# The handler's rule and the gate's rule hold whatever the model proposed.
live_drafted = [step for step in live_trace if step["tool"] == "draft_order" and step["ok"]]
for step in live_drafted:
    assert step["arguments"]["quantity"] == shop_need[step["arguments"]["sku"]], step
assert live_ledger["reserved_cents"] == sum(step["result"]["total_cents"] for step in live_drafted)
assert live_ledger["reserved_cents"] <= DRAFT_BUDGET_CENTS
assert all(entry["reason"] == "DRAFT_COST_LIMIT" for entry in live_ledger["refusals"])
assert live_drafts_path.exists() == bool(live_drafted)
```

### Challenge: make each limit end the loop, then check precedence

The admission rule is data. The next cell replays the recorded transcript four times on fresh
dispatchers, changing only `Limits`. Predict the status, `model_calls`, `tool_calls` and
`estimated_cost_cents` for each before running, working turn by turn as you did in the
`Work one iteration by hand` section:

1. `model_calls=2`: the loop admits two attempts, then stops before the third.
2. `estimated_call_cents=30, model_budget_cents=100`: 30, 60, 90 are admitted; is 120?
3. `tool_calls=2`: turn two proposes two calls when one is already spent.
4. `model_calls=3` together with the 30 cents estimate: both rules would refuse the fourth
   attempt. Which status does your transfer task say is checked first?

Note what `TOOL_LIMIT` leaves behind: the turn that proposed the calls is not appended, so the
transcript holds only the observations that were actually admitted. With a live key, rerun the
live cell under `model_calls=2` and explain what the model had done by the time it was cut off.

In your notes, separate what the scripted runs prove (the loop, the admission order, the gate,
the transcript accounting) from what only a live run can show (the model's judgment). The saved
record keeps the two apart.


```python tags=["extension", "retained-evidence"]
def scripted_run(label, **overrides):
    dispatcher, _ = build_loop_tools(SHOP, fresh_drafts_path(label))
    limits = Limits(**{**BASE_LIMITS, **overrides})
    result = run_loop(ScriptedModel(RECORDED_TURNS), dispatcher, LOOP_MESSAGES, limits=limits)
    counts = (result.status, result.model_calls, result.tool_calls, result.estimated_cost_cents)
    print(label, overrides, "->", counts)
    return result


call_limited = scripted_run("call-limit", model_calls=2)
cost_limited = scripted_run("cost-limit", estimated_call_cents=30, model_budget_cents=100)
tool_limited = scripted_run("tool-limit", tool_calls=2)
precedence = scripted_run(
    "precedence", model_calls=3, estimated_call_cents=30, model_budget_cents=100
)
assert (call_limited.status, call_limited.model_calls, call_limited.tool_calls) == (
    "MODEL_CALL_LIMIT",
    2,
    3,
)
assert (cost_limited.status, cost_limited.model_calls) == ("MODEL_COST_LIMIT", 3)
assert (cost_limited.tool_calls, cost_limited.estimated_cost_cents) == (5, 90)
assert (tool_limited.status, tool_limited.model_calls, tool_limited.tool_calls) == (
    "TOOL_LIMIT",
    2,
    1,
)
assert sum(1 for m in tool_limited.messages if m["role"] == "tool") == 1
assert (precedence.status, precedence.model_calls, precedence.estimated_cost_cents) == (
    "MODEL_CALL_LIMIT",
    3,
    90,
)
...
llm_lab_report = {
    ...
    "scripted": {
        ...
        "model_calls": scripted_result.model_calls,
        "tool_calls": scripted_result.tool_calls,
        "estimated_cost_cents": scripted_result.estimated_cost_cents,
        "refused": loop_ledger["refusals"],
        "drafted": [d["sku"] for d in scripted_drafts["drafts"]],
        "own_loop_agrees": own_counts == ("COMPLETED", 5, 6, 10),
    },
    "session": {
        ...
        "estimated_cost_cents": live_result.estimated_cost_cents,
        "drafted": [step["arguments"] for step in live_drafted],
        "refused": live_ledger["refusals"],
        "answer": live_result.answer[:400],
    },
    "limits": {
        "call_limit": call_limited.status,
        "cost_limit": cost_limited.status,
        "tool_limit": tool_limited.status,
        "precedence": precedence.status,
    },
}
llm_report_path = COURSE_WORK / "ch03-b-llm-lab-report-v1.json"
