...
jupyter:
  ...
  course:
    ...
    lesson_id: messaging
    planned_minutes: 90
    resource_id: profrod-sovereign-agent-ch08-b-messaging-repair-transfer-solution
...
# Instructor holdout appended to a submitted Chapter 6 Unit B.
...
try:
    ...
    task.close()
print("HOLDOUT_RESULT=" + json.dumps({"unit": "ch08-b", "status": "PASSED"}, sort_keys=True))
```
