...
Unit A: **Construct worker recovery**. Unit B: **Break, repair and transfer worker recovery**. Allocate ninety minutes to each,
...
The additional task is **Explain admission across an authority replacement**:
...
**Surviving limitation:** This local fence cannot recall an external request already admitted before replacement.
