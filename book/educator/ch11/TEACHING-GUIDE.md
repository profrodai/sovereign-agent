# Chapter 11: teach the mechanism, then test transfer

**Created:** 2026-09-09 · **Edition:** v1 · **Review:** classroom outcomes unobserved

## Goals and the evidence to collect

Inspect local durable intent and independent supplier rows; reconcile a lost reply without inventing another operation or spending a reservation twice.
...
**A timeout after acceptance is not evidence that no supplier order exists.**
...
The additional task is **Interpret discovery without inventing certainty**:
...
**Surviving limitation:** Supplier-fixture evidence does not establish that every real supplier supports the same discovery and identity contract.
