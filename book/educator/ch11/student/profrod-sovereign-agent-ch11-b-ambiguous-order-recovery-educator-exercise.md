...
if LEARNER_HANDOFF is not None:
    ...
    reference_encoded = (
        "c-pmDZExJT5&o`U!PA$M5_x0i&_lC;8o0Kub(8EG>rK*wYY1Fv*2}Y&R7lG9USOa<qQ9`eq##8~)XUm="
        ">Fozwq{!j$nTIpO5!sfEOZ1yy)brMyZINKNz=2%T6kh|C6SxH`1tRr8T$VudRCjtFab}xmChQZhXt}cu"
        "@u?sZerlS#W|)L+xh4fPZL)=0lM>5KK~{F@b1XMTM-FS?Kr=`gzs8jOjwNAKOoU_{CR%ShO913)QDwXF"
        "-C-e!keJGp@f>)w&kMCpLa)zRL9$(>_RZNXM5yGfWCEU&cE|XQm6a8kY$F8pQw7zYnK_ntg$39-r>5<B"
        "SO};Qo7@5ygwd4HHA8=iQSeiQj$VeIx0uhDC`Kpq_lt`pRV~l+2+cw50;o(yRh9(-j^f%Z6JF6&;Ts6a"
        "13mo(@>h)AyuigB-iega7ug1~o01VK#fxln_-az_{4l)q5JJcwlkR(0o_9Wfdv@|GihB?SYtDWLDnJIG"
        "ePs{-A&ih@5*KNv7#6=w4-XGR&+~FvTfFnyECFXsM(A0DB<9y3V}DKVWyQgdkhrO0|KiR2gAd2Ev$t=L"
        "{Rn-kFqK5^;-AB*);3?ExPep)Q`@bPubJtGdSJtrAYauz#%e*nijbdea4CVmn!-Ksj0m-Uy_pF43n&Yq"
        "L~N8&)#^9MWGrr~T8!pHTvMSd>p;j#p=dN9>Y1!-TN$$H2}*+AZM(k)j{09MASc%#B#KeKnq-Vp$kf@G"
        "z&&J@gg}qc7Q9H_CMQcf{+Gr49U7d5kAF`V2_kv?+K*7s>K4^&g_AYNY{Mu7;pO3#?lYEa7s^*r^Xy1y"
        "-)jZhHqIpDv4OSeEj5ecnq6%-+?Rxdh?Uovs6Ro7o}-@+>k+k<9Aw2QYC&wZFl^JiP1#BSztyfpBi;@("
        "G~(>;%W)MF%SuGG32_l|$bgjp2cUJwmQmP!xiTEo)*!EsS|mz!Z1r<rA7M^ytI?4^u7ZK}bGul*Wq+!G"
        "y0opU)>ys;!=LJyF)0|%MW9DFudYI8f&p!0ynS;OBC<x^E(C=DG-DJxqFf04X$|3Jzu#5YfvFwucACKt"
        "HH$c8jOVH3m<rOcNKq~&xl5-A>G&BTqj9WMH5|Jma-*zDwp+*vmWt3=pw`IKM!%YlkD1@4z_TZrhmL2b"
        "R^0&)?TfGxJ|KiX;Mx|52o3+VqY1}E06GW0B|^oqgmcCNpOwJ%p+h+Xfhdz`1qGwmNHQchMChgc&Kep&"
        "3pUMbz1~<QT-TVj(7<-7qHz7B3-4jya$gek>N2<~`dV?5dWPJEPoLZstQm(?->c(C3RZjL-$0`ARgT~u"
        "W2_$>%p6rv7vb&3>P@?9be3^Sh66d~FwQUb_!h1DS^`fCCd5}_(S-5gvZEeqzn3zfF;Gr&eO1XhE0Np)"
        "S`#kREnk$3im@w~rk?q#W=p_9mtl&29JWmEQ%S!|GnF=L1XQ!h{%ze*zYd;-b@{Nq$M|D~fA_a$m1bCD"
        "%7U?*stoqs1sjj{m6m9uj9zgl)b$*nM^V_9ER7F#5-6>&%fdZVTAKM&hjV*IYpGWHo-vJ?jWwnnQw}FR"
        ">^rrsHoZe@8NP2~;LaQ-O&z&z+7#+^M&&XQI^63_46+@K+FWU`PG;Ir9V>6B$!KEb$m|}G7#(>7#ug)9"
        "%!$LQsl$h#ZH|r(DoW%5KG<NIv-SGm_GqGFs2@)5IFXP_xOeWLPIzs2+y>ZwxlVof^8ZEss4k=tdL8?f"
        "Tp#?|cfN(0kbE+q&1}`65q;@W^~(8x;|{6$>AVfS*6DSnpUr3KY`#nv$?@s0=)eE|58_Z_!iOh3Qa+EW"
        "PtyorV?rk?=-Y3sDF^*Y+#X<GVW`q34JbA@ZXZh(_*Hs0MMtJDW81QTx=(4=%^6Hpz+Yp1bFYUeFFZa>"
        "+>o-=;|?3~wr1iajVh&Sy^hIdEDBaxV}CX6<Kk?&OlEuM+4qt6U=yn3pUL9nOnvE3&gY9|?4#!{S9-t="
        "coO~(u4pMy"
    )
...
def run_partner_fixture(normalizer, decision):
    with tempfile.TemporaryDirectory(prefix="ch09-partner-") as directory:
        ...
        policy = SpendingPolicy(frozenset({"lucy"}), total_cents=2_000)
        try:
            seed_lucy(db)
...
STANDING_APPROVAL = {"sku": "SKU-VANILLA", "quantity": 6, "ceiling_cents": 2000}
...
def open_shop(tag, *, reject=False):
    ...
    def lucy_gate(call):
        ...
        if call.name == "propose_order":
            ...
            if (call.arguments["sku"], call.arguments["quantity"]) != wanted:
                ...
                raise PermissionError("Lucy did not authorize that proposal")
        ...
        try:
            ...
            raise
        if row["status"] == "DRAFT" and row["amount"] <= STANDING_APPROVAL["ceiling_cents"]:
            approve(
    ...
    def order_status(_):
        ...
        return {"orders": lab.orders(), "reserved_cents": reserved, "spent_cents": spent}
...
and spent cents, and how many rows does the supplier hold? After turn five, one row or two, and
...
assert scripted_trace[4]["result"]["reserved_cents"] == 1500
assert scripted_trace[4]["result"]["spent_cents"] == 0
...
ledger did not reserve, or send a product Lucy did not authorize: those rules live in
...
spent cents. Notice that the recorded final sentence still says "confirmed". The transcript is
