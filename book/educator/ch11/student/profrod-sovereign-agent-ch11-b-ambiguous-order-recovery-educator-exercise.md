...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/profrodai/sovereign-agent/blob/main/book/exercises/ch11/profrod-sovereign-agent-ch11-b-ambiguous-order-recovery-exercise.ipynb) Runs on Google Colab as it ships today, or on any local Python 3.12+ kernel.
...
if LEARNER_HANDOFF is not None:
    ...
    reference_encoded = (
        "c-pmD>vG$;75>ksK>26MEXCN_=}zMrHsjjNR!t&lBqiyN>)}u&WMfT{3<28FW<1k}=o9uydT=Abi)<(9"
        "`iDh;z`?nn4~Jw|78OIk(IU63ZB^_LEpBmz$yFZ3S2$-rzJ>o35xFofOPr^Xn6xZn>{ibO)lXHOmwP>+"
        "pEAPmPt9=OEMs_AZb^olG1+0sNg1>2jBNDL3m7UME4&3B^8`mlbrt92_n46)r#@vxg?+)d-bFD^qpVK$"
        "<I=^H63XJ70i_gIjhrhkCdscBMMjdn$K|eItB2sHEGT}A+FeoIXj(}Ylbwff{;9_Gft_j0;!RAk-gB<T"
        "mIXAi)R+%jD99O+d|RNu2FUrzL&q;%%UaIoYZRcf`TON6jQGd`<K!vkQULjg)@7LyT)`q?79ajcT)z%w"
        "l_R!4NA{*DZl1^4UA(7Jkv~taadJ}@1k4Z5M=$+yZ@cb=h2YN~qi$Q5mbI9_ou2&)2X$5GfY`s|oMPsD"
        "vAI3$d)Gs(U~v|e+?2tK=;-JOgt1b*)%s4QS)8gUn1`OhhPb-IEU>raGpj3Xdx+lDfxUY3e)8dTHhuf{"
        "6sA7aU;@JS!O!lA;5OX=KU$@N7#CM+UV5hOiiM50IO#^tD67HPLw0f<mkd`gPw;14C4}<xr7-Zj#ASwa"
        "La#Yf_2xI6umG5oWQ0Ei(iOV2CY04&i;4rnpUGC*N;#X@z$pl6TlpGw$R9}{C0Cd-*qm<sq{wq%1AN8@"
        "j+2^UN30PRT!nALv$bCTdO3fG2GQ{G@8L28o`P2(l+*I&$+KL4i&=7A<k)d9jxNQVvRr!*FyA~I6x#QK"
        "fp#1x5XFH~YcpF4FAAi0wbS@>Nh(YOo;7^_&vDU@=;tH3LULJQaFrajN^H4M-X^4tiVZ~Ctw<$8<Lxr#"
        "Mpbe5biINeSxr4@!Z`CPoM2M^9~3PncJR1=Iy0am5Dk1=gqlZ79=77S&kt2m+j4YlkF%iE`lUTgifo^7"
        "MP2C8Wos;3D+8ABn&D?foKi=uZeCrw#s;Odk@fn`rHjZGb*B){Ad}93)eb3B1wc`#@S;C&vTLZRU2jgR"
        "#rM*S;C!%V#Hu)_r12u|auG>QcY<2L>!*hl#{p+m`Pdy{*W9XPx5Fuk8F%QIqSnYK4S&)dA2Pq`0?!`x"
        "Jajrc*X$1bP`_{+;sb{e0WNHT2o>r->2OlTkTKB$S35#^9Sf_fs2sZ}aV3Hdr3I!ahvdA$SphD{3dF8~"
        "6hGSToFVjwf&kg4=kKO#yL*s!2<?IBPkiBGv7CPh&wFbhVl2=0D9)Q&gj!B_@gA6ja?#{%{r8wTgh}2n"
        "&QI6j&=#vu=Z)ZpRX97J&VKpfvDDC*qcbvbnyfd?VZJ!bhqBJO_s|zxOn`^CwC`JLIP2*9{p`(b{&Dsc"
        "jVlShLE-6+Fa`<-{iaISNwLGI&TsPKF8`xcu4MZLmG_ji49~*pV#F=Ea}!E(&O!o6M8>}dH85fBAw7MF"
        "vl=TE=_*p;Pc;<2w5JNlN<|8a3uL}b>s?8Q%1}gnzzj~Ccma-4fS%C}-qT=R)c|%WE@SZcqN0IgdmQAP"
        "@MUq96?ah{=fUe3GVKFyNVeU>nh3I8?ji=*DXNBfc+o2fU!$2OiR@y?P5=-9Pax&&4>PBn*OgX+%4VOQ"
        "orQ}v<O~k)!hb*-h3EUP;f6?Fz(td+rsNin@X!eyaqiiC_IkQ}_xQoE{ei;B6)8u<oe#4O{6ZPyUP)D1"
        "<LR$vJPLaf7*OC*81=B|joNkM@Y-~9|MVo%B<Z_YDqp9Q9^-M6;F5`8QDPgsh|;31|A%CoR~ivQ;WhKk"
        "fS6;r16NwZw?H|qdw6EdE81>H{oVtS`fXx0XpsxnMN&a`IC<sSLxKjF3XJC;UzzZ8L?yy;;$2ZgP+xke"
        "GaTyZ=t0RlrE+kTd3$Nt?$=TtB6&hG@Uh|QvHI$nV7c#n_uj!OLq{Q%8NsSVq85eP9k~8@j0!A!1<{X9"
        "D4WD!=oIj%iBom&#$RLJwur0!ITR&+f7?4{h2fGO*t~NvX$ehkq5f?$Jh26?P4)T{^S(H^r$LPNIs&{K"
        "<TSh8R!PjHrC>6J{TG*mSznsIm8}8nejl(aoawsXMMP(_9vNNefXheCW0pm0q^JXpFGiW|Ih}C<Yc8gS"
        "E4C@`{=4MV_@}wye5c+XqbKzxQu#%<rfdOMhzm(B4(+N;U!wV&i^=ij$Ys!Y*SYw0Gl*=_wOjxjV?_)e"
        "JC(g1jM7u=1;{z_(D9#nbF9NXp%UT*0zNh=e{_-QHrz#?Ju~dD`$^ydFJE>oKZqt#E56EPnuQ)x{me78"
        "k-CP*l%R+1o<aU=bKt4aSqlU7sbCHr8M-L+aDeV(7-6tDU9F^v_#EbQ+PE+$?4lb2_f}7$Q2cQG0qG47"
        "B^x<z7KZ1m=;M6(h94>Rz%<*J*bxKQj{t4&a1^ztZAlI=yk{KV4a#`Kkhf7)q6KRYlKG%h;aVT2tLfj~"
        "hLIE<HmU7BOr$hpl@&m0#{e8^Ie3BS2?sAAMCBq|lLmKRFHg_7PiQ*4R`*VpsK!tU$fCfB2yot4um;<{"
        "r6@I257#2mDh^Pu*fg)jd1IY$(PI`w9X-XH!tzNp-rc_Co>KH=8(cMgH924IV0-uR$lYK_h&U4W>fnKf"
        ")xr8Vpr~?{LAd8JIu8zZjxs2k@LDh_w8=*27^7u4pre9uzB-Uw1nXM{#(;RCU#W|xj1P|;%}|H4l=_ST"
        "u9u3dN(v$&c8wvtE6Q*Av@CKucI6VTr@pG`7O>OxFz$X8-WBW+OX6LWaM&y~z=sX`*L_3r+Ii;6_MyDT"
        "*kg@<^KT2AxQ8{S%!=ZsE}cVn!6u`9r6t-bBTgI=H8aPTQ7s$-OXG_T044Y}z3{-6*3Dp3J2<dfP}S5A"
        "tZB@wtZ~vY<#5yep{Q-S=>@I!@IxCNbLS8=b?BO~$rW&hV;K(}9ZV)lvmK6FtaOkkwQb0brZ?nd6j&KF"
        "yCD*wV{72C*+>>M>M$RQ@&PsH_;^z1giYefH6W;ByPez~`@DuiJl$0g$q~b!jXS7OUK>Ad3v9n#$3J}8"
        "|H^GoHqzi$9@sV8PX1yW-@;T$25ruC*PtPNVY=$2@d3wNBK^~N>soEn>r$W2XVGlFj+Wu+`LF1||NalC"
        "vy4eKjBt<VyqtfUM)6fla-SD{{f#w(UHp@{4q%(>ki#aS&{*BL?U?bx&*9w(I#zQ@u`4qy=Qw9w%%Hjg"
        "_BIwbce#XT;qhhkhQN)5uRChU>z;`L8abqCvyMVDS__(4Wq-cy<8r!QhqHtG^n1^`*MKVgXSh6@@-O}2"
        "V!m7lHdx;9m7d}Te&YTQR){Dc"
    )
...
## Extension: put a language model behind the ambiguous order

Every transition above was driven by your own code. In production the caller that asks for an
order is a model, and the reason `SENDING`, `UNKNOWN` and the exact receipt live in SQLite
rather than in a prompt is that a model must not be able to invent certainty about money. This
closing section puts a model behind the same rows and shows what it can and cannot do.

The mechanism is the Chapter 3 loop, `agent_loop.run_loop`, with tools that wrap the real
`assistant_orders` functions. The model can propose an exact order and ask for it to be sent.
It cannot choose the operation identity: `propose` derives one from the work item and the
proposal digest, so asking twice yields the same identifier. It cannot settle anything: only a
receipt whose `operation` and `proposal` match the stored row settles the reservation, and
`execute` looks for that receipt before it would ever transmit again. It cannot release money:
`UNKNOWN` keeps the reservation until conclusive evidence arrives. The supplier is an in-process
copy of the loopback fixture's rules: it commits to its own SQLite file, then loses the reply.

**Prediction:** the next cell builds the dispatcher and prints the schemas. Write down which
tools change durable state, which argument names the product rather than an order identifier,
and why the model is never shown an argument for the operation identity.
...
from reference_organizations.store.agent import (
    DraftArguments,
    NoArguments,
    StockArguments,
    shop_dispatcher,
...
# Lucy's standing instruction for this morning: one exact proposal, nothing else.
STANDING_APPROVAL = {"sku": "SKU-VANILLA", "quantity": 6, "ceiling_pence": 2000}


def fresh_file(path):
    """Remove a SQLite file and its sidecars so reruns and replays start from nothing."""
    for stale in (path, Path(f"{path}-wal"), Path(f"{path}-shm"), path.with_suffix(".authority")):
        stale.unlink(missing_ok=True)
    return path


class LostReplySupplier:
    """The loopback fixture's rules in one process: commit first, then lose the first reply."""

    idempotent = True
    identity = "lucy-local@notebook-fixture"
    timeout = 3.0

    def __init__(self, path, *, reject=False):
        self.connection = sqlite3.connect(fresh_file(path))
        self.connection.execute(
            "CREATE TABLE orders(operation TEXT PRIMARY KEY,proposal TEXT NOT NULL,"
    ...
    def order(self, operation, proposal):
        ...
        if row is not None:
            if row[0] != encoded:
                raise ValueError("identity conflict: same operation, different proposal")
        ...
        raise OSError("connection closed before the reply arrived")

    def remote_orders(self):
...
class OrderLab:
    ...
    def spending(self):
        ...
        return (0, 0) if row is None else tuple(row)

    def orders(self):
        return [
            dict(row)
            for row in self.db.connection.execute(
                "SELECT id,status,amount,proposal FROM assistant_orders WHERE work_id=? "
                "ORDER BY created,id",
                (self.work.id,),
            )
        ]
    ...
    def order_events(self):
        return [
            row[0]
            for row in self.db.connection.execute(
                "SELECT kind FROM events WHERE kind LIKE 'assistant.order.%' ORDER BY seq"
            )
        ]

    def close(self):
        self.db.close()
        self.supplier.connection.close()


def open_shop(tag, *, reject=False):
    """A fresh shop ledger, one claimed work item and a supplier that loses its first reply."""
    db = Database(fresh_file(COURSE_WORK / f"ch11-{tag}-shop.sqlite"))
    seed_lucy(db)
    enqueue(db, f"ch11:{tag}", "lucy", "Replenish stock this morning")
    work = claim(db, "notebook-worker", ttl=3600)
    supplier = LostReplySupplier(COURSE_WORK / f"ch11-{tag}-supplier.sqlite", reject=reject)
    lab = OrderLab(db, supplier, work, None)

    def current_order(sku):
        row = db.connection.execute(
            "SELECT * FROM assistant_orders WHERE work_id=? AND json_extract(proposal,'$.sku')=? "
            "AND revoked=0 ORDER BY created DESC LIMIT 1",
            (work.id, sku),
        ).fetchone()
        if row is None:
            raise ValueError("no proposal exists for that product")
        return row

    def lucy_gate(call):
        """Lucy's standing approval, checked at the boundary and recorded in the real ledger."""
        if call.name == "propose_order":
            wanted = (STANDING_APPROVAL["sku"], STANDING_APPROVAL["quantity"])
            if (call.arguments["sku"], call.arguments["quantity"]) != wanted:
                lab.ledger.append((call.name, call.arguments["sku"], "outside_standing_approval"))
                raise PermissionError("Lucy did not authorise that proposal")
            lab.ledger.append((call.name, call.arguments["sku"], "draft_allowed"))
            return
        try:
            row = current_order(call.arguments["sku"])
        except ValueError:
            lab.ledger.append((call.name, call.arguments["sku"], "no_proposal_to_send"))
            raise
        if row["status"] == "DRAFT" and row["amount"] <= STANDING_APPROVAL["ceiling_pence"]:
            approve(
                db, row["id"], row["digest"], actor="lucy", policy=POLICY, expires=time.time() + 600
            )
            lab.ledger.append((call.name, call.arguments["sku"], "approved_by_lucy"))
        elif row["status"] in {"APPROVED", "SENDING", "UNKNOWN"}:
            lab.ledger.append((call.name, call.arguments["sku"], "same_operation_retry"))
        else:
            lab.ledger.append((call.name, call.arguments["sku"], "already_settled"))

    def propose_order(args):
        identifier = propose(db, work, args.sku, args.quantity, target=supplier.identity)
        row = db.connection.execute(
            "SELECT status,amount FROM assistant_orders WHERE id=?", (identifier,)
        ).fetchone()
        return {"sku": args.sku, "quantity": args.quantity, "operation": identifier, **dict(row)}

    def send_order(args):
        return execute(db, work, current_order(args.sku)["id"], supplier, policy=POLICY)

    def order_status(_):
        reserved, spent = lab.spending()
        return {"orders": lab.orders(), "reserved_pence": reserved, "spent_pence": spent}

    tools = [
        shop_dispatcher(db).tools["list_stock"],
        ExecutableTool(
            "order_status",
            "Read this work item's orders and the money ledger.",
            NoArguments,
            order_status,
        ),
        ExecutableTool(
            "propose_order",
            "Record one exact order proposal for a product. Never purchases.",
            DraftArguments,
            propose_order,
            consequential=True,
        ),
        ExecutableTool(
            "send_order",
            "Send the recorded proposal for a product to the supplier, or read back its receipt.",
            StockArguments,
            send_order,
            consequential=True,
        ),
    ]
    lab.dispatcher = Dispatcher(
        tools, allowed=frozenset(tool.name for tool in tools), before_write=lucy_gate
    )
    return lab


scripted_lab = open_shop("scripted")
for tool_schema in scripted_lab.dispatcher.schemas():
...
print(
    ...
    {
        row["sku"]: row["needed"]
        for row in scripted_lab.dispatcher.tools["list_stock"].handler(NoArguments())
    },
)
try:
    StockArguments(sku="SKU-VANILLA", operation="made-up")
except ValidationError:
    print("An operation identity in the arguments is refused before any handler runs.")
ORDER_MESSAGES = [
    {
        "role": "system",
        "content": (
            "You help Lucy run her ice cream shop. Read stock first. Propose an order only for "
            "what the shop needs, then send it. A reply of UNKNOWN means the supplier's answer "
            "was lost, not that the order failed: send the same product again so the runtime "
            "can look up the receipt. Finish with a short plain summary of what the ledger shows."
        ),
    },
    {
        "role": "user",
        "content": "Order what we need this morning and tell me where the money stands.",
    },
]
```

Four tools, two of them consequential. `propose_order` writes a `DRAFT` row through the real
`propose`; `send_order` runs the real `execute`, which admits `SENDING`, calls the supplier and
records `UNKNOWN` when the reply is lost. Neither schema has an argument for the operation
identity, and the strict `StockArguments` class refused one: the model names a product, the
runtime derives the identity.

The gate is Lucy's standing approval. A proposal outside it is refused before the handler runs.
A `send_order` for a `DRAFT` that fits is approved in the ledger with the real `approve`, under
Lucy's name; a second `send_order` for the same product is a retry of the same operation, the
retry Unit B repairs: same identity, no fresh UUID.

### Run the loop against a recorded transcript

Turn one reads stock. Turn two proposes vanilla and strawberry. Turn three sends vanilla. Turn
four reads the ledger. Turn five sends vanilla again. Turn six answers.

**Prediction:** which proposal is refused, and by whom? After turn three, what are the reserved
and spent pence, and how many rows does the supplier hold? After turn five, one row or two, and
which event settles the money? Write both ledgers down.
...
RECORDED_TURNS = [
    ...
    scripted_turn(
        calls=[
            {"name": "propose_order", "arguments": {"sku": "SKU-VANILLA", "quantity": 6}},
            {"name": "propose_order", "arguments": {"sku": "SKU-STRAWBERRY", "quantity": 4}},
        ]
    ),
    ...
    scripted_turn(
        ...
        "The strawberry proposal was refused because Lucy only authorised vanilla."
    ),
]
LOOP_LIMITS = Limits(model_calls=8, tool_calls=16, seconds=120, output_tokens=4096)

scripted_result = run_loop(
    ScriptedModel(RECORDED_TURNS), scripted_lab.dispatcher, ORDER_MESSAGES, limits=LOOP_LIMITS
)
print(describe(scripted_result, "scripted"))
print("Gate ledger:", scripted_lab.ledger)
print("Order events:", scripted_lab.order_events())
scripted_trace = tool_trace(scripted_result)
assert scripted_result.status == "COMPLETED"
assert [step["ok"] for step in scripted_trace] == [True, True, False, True, True, True]
assert scripted_trace[2]["result"] == "tool_failed"
assert scripted_lab.ledger[1] == ("propose_order", "SKU-STRAWBERRY", "outside_standing_approval")
# The lost reply left the intent durable and the money reserved, with one remote row.
assert scripted_trace[3]["result"]["status"] == "UNKNOWN"
assert scripted_trace[4]["result"]["reserved_pence"] == 1500
assert scripted_trace[4]["result"]["spent_pence"] == 0
# The retry kept the same operation identity and found the receipt instead of sending again.
assert scripted_trace[5]["result"]["status"] == "ACCEPTED"
assert scripted_trace[5]["result"]["operation"] == scripted_trace[3]["result"]["operation"]
assert scripted_lab.supplier.remote_orders() == 1
assert [row["status"] for row in scripted_lab.orders()] == ["CONFIRMED"]
assert scripted_lab.spending() == (0, 1500)
assert scripted_lab.order_events() == [
    "assistant.order.approved",
    "assistant.order.intent",
...
local kernel run `%pip install openai` once. The model may read the ledger more often, retry
sooner, or give up on the lost reply. It cannot create a second supplier row, spend money the
ledger did not reserve, or send a product Lucy did not authorise: those rules live in
`propose`, `execute` and the gate.

**Prediction:** write down what a careful assistant should do on seeing `UNKNOWN`. Then run the
cell and compare the model's choice, or the recorded transcript when the run is scripted.


```python tags=["extension", "live-model"]
from sovereign_agent.llm_lab import DEFAULT_MODEL, build_model, resolve_api_key

live_lab = open_shop("live")
...
live_result = run_loop(chosen_model, live_lab.dispatcher, ORDER_MESSAGES, limits=LOOP_LIMITS)
print(describe(live_result, chosen_model.source))
print("Gate ledger:", live_lab.ledger)
print("Orders:", [(row["status"], row["amount"]) for row in live_lab.orders()])
print(
    "Reserved and spent:",
    live_lab.spending(),
    "| supplier rows:",
    live_lab.supplier.remote_orders(),
)
live_trace = tool_trace(live_result)
assert live_result.status in {"COMPLETED", "MODEL_CALL_LIMIT", "TOOL_LIMIT", "MODEL_FAILED"}
# Whatever the model did: at most one remote effect, and it matches a stored exact proposal.
assert live_lab.supplier.remote_orders() <= 1
for operation, encoded in live_lab.supplier.connection.execute(
    "SELECT operation,proposal FROM orders"
):
    stored = live_lab.db.connection.execute(
        "SELECT proposal FROM assistant_orders WHERE id=?", (operation,)
    ).fetchone()
    assert stored is not None and json.loads(stored[0]) == json.loads(encoded)
# The money ledger equals the sum of the order rows, whatever their states.
held = sum(
    row["amount"]
    for row in live_lab.orders()
    if row["status"] in {"APPROVED", "SENDING", "UNKNOWN"}
)
spent = sum(
    row["amount"] for row in live_lab.orders() if row["status"] in {"CONFIRMED", "DELIVERED"}
)
assert live_lab.spending() == (held, spent)
# Only Lucy's standing proposal was ever approved through the gate.
assert all(
    sku == STANDING_APPROVAL["sku"]
    for _, sku, decision in live_lab.ledger
    if decision == "approved_by_lucy"
)
assert all(
...
### Challenge: stop the loop early, then let the supplier say no

Two changed conditions, same recorded transcript. First, `Limits(tool_calls=4)`: predict which
turn the loop refuses, what the order row holds when it stops, and whether the reservation is
still there. Then settle that order with the real `execute` and no model at all, and say what
that proves about recovery. Second, a supplier that commits `REJECTED` and still loses its
reply: predict the first `send_order` result, the row after the retry, and the reserved and
spent pence. Notice that the recorded final sentence still says "confirmed". The transcript is
the model's claim; the rows are the evidence. Which one do you report to Lucy?

In your notes, separate what the scripted run proves (the transitions, the stable identity, the
single remote row, the money accounting) from what only a live run can show (whether the model
retries the same product, reads the ledger, or invents a story). The saved record keeps the two
apart.


```python tags=["extension", "retained-evidence"]
tight_lab = open_shop("tight")
tight_result = run_loop(
    ScriptedModel(RECORDED_TURNS),
    tight_lab.dispatcher,
    ORDER_MESSAGES,
    limits=Limits(model_calls=8, tool_calls=4, seconds=120, output_tokens=4096),
)
print("Tight budget:", tight_result.status, "after", tight_result.tool_calls, "tool calls")
print("Rows when it stopped:", [row["status"] for row in tight_lab.orders()], tight_lab.spending())
assert tight_result.status == "TOOL_LIMIT" and tight_result.tool_calls == 4
assert [row["status"] for row in tight_lab.orders()] == ["UNKNOWN"]
assert tight_lab.spending() == (1500, 0) and tight_lab.supplier.remote_orders() == 1
# Recovery reads the supplier's evidence; it does not ask a model anything.
recovered = execute(
    tight_lab.db, tight_lab.work, tight_lab.orders()[0]["id"], tight_lab.supplier, policy=POLICY
)
assert recovered["status"] == "ACCEPTED" and tight_lab.spending() == (0, 1500)
print("Settled without a model:", recovered["status"], tight_lab.spending())

reject_lab = open_shop("reject", reject=True)
reject_result = run_loop(
    ScriptedModel(RECORDED_TURNS), reject_lab.dispatcher, ORDER_MESSAGES, limits=LOOP_LIMITS
)
reject_trace = tool_trace(reject_result)
print("Rejecting supplier:", [row["status"] for row in reject_lab.orders()], reject_lab.spending())
assert reject_trace[3]["result"]["status"] == "UNKNOWN"
assert reject_trace[5]["result"]["status"] == "REJECTED"
assert [row["status"] for row in reject_lab.orders()] == ["REJECTED"]
assert reject_lab.spending() == (0, 0) and reject_lab.supplier.remote_orders() == 1
assert "confirmed" in reject_result.answer  # the recorded prose, not the evidence
...
llm_lab_report = {
    ...
    "scripted": {
        ...
        "refused": [decision for _, _, decision in scripted_lab.ledger if "outside" in decision],
        "orders": [row["status"] for row in scripted_lab.orders()],
        "reserved_and_spent": list(scripted_lab.spending()),
        "supplier_rows": scripted_lab.supplier.remote_orders(),
    },
    "session": {
        ...
        "gate": [list(entry) for entry in live_lab.ledger],
        "orders": [row["status"] for row in live_lab.orders()],
        "reserved_and_spent": list(live_lab.spending()),
        "supplier_rows": live_lab.supplier.remote_orders(),
        "answer": live_result.answer[:400],
    },
    "tight_budget": {
        "limits": {"tool_calls": 4},
        "status": tight_result.status,
        "recovered": recovered["status"],
    },
    "rejecting_supplier": {
        "orders": [row["status"] for row in reject_lab.orders()],
        "reserved_and_spent": list(reject_lab.spending()),
    },
}
llm_report_path = COURSE_WORK / "ch11-b-llm-lab-report-v1.json"
...
for open_lab in (scripted_lab, live_lab, tight_lab, reject_lab):
    open_lab.close()
```
