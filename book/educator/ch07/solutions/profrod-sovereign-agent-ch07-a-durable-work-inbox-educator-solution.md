...
**"Capacity is checked first."** Identity must come first. A full inbox must still recognise a request it has already promised, or Lucy is told "refused" for work that is already queued.
