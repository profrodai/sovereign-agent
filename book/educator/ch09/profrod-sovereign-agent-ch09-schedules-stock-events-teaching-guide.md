...
Unit A: **Construct scheduling**. Unit B: **Break, repair and transfer scheduling**. Allocate ninety minutes to each,
...
The additional task is **Coalesce while preserving a deferred due job**:
...
**Surviving limitation:** This does not guarantee a running host or a wakeup at an exact wall-clock time.
