...
CATERING_MESSAGES = [
    {
        ...
        "content": (
            ...
            "catering_quote, which is fixed arithmetic over the catalogue: ten portions per tub, "
            ...
            "a short plain-words summary: tubs, GBP total, whether the worker verified the "
...
**Prediction:** how many tubs, what total in pence, and how many model calls does the worker
...
def recorded_turns(model_calls):
    return [
        ...
        scripted_turn(
            "Eleven guests need 2 tubs of vanilla, GBP 10.00 as a draft. Twelve model calls was "
...
assert scripted_trace[0]["result"]["total_pence"] == 1000
...
assert scripted_report["result"].startswith("Catering draft: 2 tubs for 11 guests, GBP 10.00.")
...
for step in live_trace:
    if step["tool"] == "catering_quote" and step["ok"]:
        ...
        assert step["result"]["total_pence"] == step["result"]["tubs"] * 500, step
