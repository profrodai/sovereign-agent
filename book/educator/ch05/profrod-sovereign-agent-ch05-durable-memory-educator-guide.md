# Teach Chapter 5: Memory and retrieval: what the model sees, and a memory that forgets
...
[Preparation, timing, hints and rubric](profrod-sovereign-agent-ch05-durable-memory-teaching-guide.md)
