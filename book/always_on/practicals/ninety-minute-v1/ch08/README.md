...
|---|---|---|---|
| A · 90 min | Construct exact approval | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer exact approval | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch08-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch08-instructor-pack-v1.zip) ·
