...
|---|---|---|---|
| A · 90 min | Construct tool isolation | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer tool isolation | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch11-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch11-instructor-pack-v1.zip) ·
