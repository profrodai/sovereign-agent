...
|---|---|---|---|
| A · 90 min | Construct versioned skills | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer versioned skills | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch05-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch05-instructor-pack-v1.zip) ·
