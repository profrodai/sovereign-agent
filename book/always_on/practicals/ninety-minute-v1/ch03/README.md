...
|---|---|---|---|
| A · 90 min | Build a bounded model and tool loop | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Repair failed-call accounting | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch03-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch03-instructor-pack-v1.zip) ·
