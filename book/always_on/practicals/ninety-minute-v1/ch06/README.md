...
|---|---|---|---|
| A · 90 min | Construct private messaging | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer private messaging | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch06-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch06-instructor-pack-v1.zip) ·
