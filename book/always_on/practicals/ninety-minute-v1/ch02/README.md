...
|---|---|---|---|
| A · 90 min | Construct typed shop tools | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer typed shop tools | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch02-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch02-instructor-pack-v1.zip) ·
