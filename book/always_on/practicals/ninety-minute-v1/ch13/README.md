...
|---|---|---|---|
| A · 90 min | Construct controlled improvement | [Notebook](student/unit-a-v1.ipynb) | [Text](student/unit-a-v1.md) |
| B · 90 min | Break, repair and transfer controlled improvement | [Notebook](student/unit-b-v1.ipynb) | [Text](student/unit-b-v1.md) |

[Student chapter ZIP](ch13-student-pack-v1.zip) ·
[Instructor chapter ZIP](ch13-instructor-pack-v1.zip) ·
