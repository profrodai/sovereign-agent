...
The additional task is **Build an oracle that cannot copy the expected answer**:
...
**Surviving limitation:** A passing finite scenario suite is not proof of arbitrary language faithfulness.
