# Chapter 14 instructor guide — Bounded delegation

**Created:** 2026-09-09 · **Status:** DRAFT / PEDAGOGY UNREVIEWED

## Objective and observable evidence

Build a deterministic catering quote from the catalog and a validated Inquiry. Round portions upward, validate the selling price and return an explicit draft with no stock reservation. Invoke the actual quote tool used by the delegated research path and inspect product identity, total and unchanged stock.
...
Floor division underquotes any partial tub. Ask what Lucy loses: Lucy’s catering quote leaves one guest without a portion.
...
A delegated draft neither reserves stock nor authorizes a purchase. Trusted subprocess execution is not OS/network containment. Student code can inspect its checkout; instructor-held cases are assessment separation, not a security boundary against hostile filesystem access.
