...
|---|---|---|---|
| A · 90 minutes | [A: schedules stock events](profrod-sovereign-agent-ch09-a-schedules-stock-events-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch09-a-schedules-stock-events-exercise.md) | Construct, connect and explain |
| B · 90 minutes | [B: scheduling repair transfer](profrod-sovereign-agent-ch09-b-scheduling-repair-transfer-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch09-b-scheduling-repair-transfer-exercise.md) | Diagnose, repair and transfer |
