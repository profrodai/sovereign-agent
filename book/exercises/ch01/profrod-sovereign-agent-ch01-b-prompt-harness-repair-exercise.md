...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/profrodai/sovereign-agent/blob/main/book/exercises/ch01/profrod-sovereign-agent-ch01-b-prompt-harness-repair-exercise.ipynb) Runs on Google Colab as it ships today, or on any local Python 3.12+ kernel.
...
identities, quantities and integer-cents calculations.
...
if LEARNER_HANDOFF is not None:
    ...
    reference_encoded = (
        "c-oy=(Qey15`EWK%<{>?Rg9#28(etd1>8hwjRtnscA71`hCoZ>n2k(oNh+~X1lW(*FWfI#kfLPCmecn3"
        "A(hDCaOTV*XGUh5Oh^r}$aWqpp4U{ZQ?@K$zbV1XXSGw_N{S6+R2vy^<9AfAJ&!7dg;4hyrDB3djIRXz"
        "y$_wg25@oVd*1ZZ_zwE;-2(t1ajvx3pd>vYw|TrHK{+lZ@_1*)@2A)0a3)2P$6Apd%<YKz_noMx+z3uT"
        "-=BRMjE1+j0}=q?bc1I23*{_LsTmSHT2r2o9=r>HNE9+b8D)ZTO?vRhYtXLr>eKjYd^?zhb+uP(5sQ>+"
        "Y%0EJ(|mbK^K>>DJbVZzldpBvQ!VMs5~bW7=x$N{-l<*$-mB+%39dkC5kEyM8f(>2YmxaqD<M(mlGlN&"
        "o-DY9Sq|d4eO&}i5ocf}W8V*j_V!kC<<OBn!~~7xhHg9O!G1y0%LSaZ=<@f<UaO~-kfkUv4oXOkiA7<)"
        "XU`&lC*1W@x>+U^n8r=d{&i0K1)!ei-3+c~Q|LDkH3as(Ofs%J=4f=2e3Pk;6%By#1i9|N^ZoKP%sW!N"
        "lyHK5c5W|xYpxV8##F0d0sX#<Q0Itx=g#BKF?D`#OzjWBr5|{Uf)yK7iaz2mQ9_E;5>oAy#tk`$UM#pq"
        "OTtcL!cIO&rV-4U1`29zE{Tnhobks3O;}2Xt1jFt1i{lC=rw}Mvn*wpm<1VFyt_b-m0t_sLPM6zcuf@o"
        "<vYDLs)d9&rECLwO*K#smPUYErnKrdHP!i3Kc1!2xk72q-`>qyxQ&5<rC0QXJJp}b9R2brx^tM(T`Fke"
        "WH%zgv`<!St8<BG_LVf_ut%R1)4gI<P#bqqG*gX$)?}2HNH?ShH#AjPo6xw)P*Sr$>A`tjE!{?1JRvuV"
        "-@U&qrp$#h3IA~)PG``s+&OUooM77#uu^7iB{knWvY1~i<`u{b-<$xmMS-D2nnac=okYa>2Dx^av6bZj"
        "Q;aK3d5o1n011mrF$*tc3gHV)a}1>vvO{9A$x_rza6tZysmKsExzeyi%bMjkj5R4Pf_N=hj0*ZtZqR*1"
        "-63w=NgbQx<^xEX(!QZ)io6{4;V*r-c*{h=5o%^i{CCbICJm#YUs^XmU%Y9C!^9pCJ5czrVw|aUB#|n?"
        "i8YESEi&?x;3X`v`xSbC3%Q|bx^qUl7*|#nd%Dq+xVibCh$2;rnMJzV=>R2GU3<mW_GlMgR%^-6?NASe"
        "NPoDK79x#enx=}p=|YxL#zEs&gG7}Hu72zUu5v|F;sa9_yOH4d)*fy_DNajYFexr!w~sZV-`uM_mZxH6"
        ")&!umw9GP-W~8gMWLf7;$GPCR$@H!;;m~JyAsS_#_i;SFjwa#sZakWXwc630zuxKm)ueaNar+>Rm3-_S"
        "tZrn$Jzauhp?!uZi%l>oUcn{ke5w9s0CEMLoA|v8BjJ+M3ssP%G{&TRp#1f)!daLa@5^vH{BRpaSA%J2"
        "iW65ZG*AkF46d%iyBR49gYR{`7Ow%2NqBQV4J(0D7`DN@PnJgrr^p}m+T_g|u5B<L!bV<S8~PV**|{{j"
        "7&$h*ZteF|;cqwXINcM)w&eA7@eBL^0(3_sKh4;mV(u?7xQ)qgiPdg53v}7IEb|?CU9>NJJs$ou0WXWI"
        "M@bVjI3*}MG35zMsKx+ds!)|>m3T2}dtPWZwKmT;OOyfBY6aY87;8*?Q-mYWH>N_uj@1*uMeP!+s?)x0"
        "m%9mKW*+vHNhPY~uGer*qRLZqy;i1nN_G2HxQ#K>(AnRU0nBz;`S=-k?rF#q+`8w1){-rAT}b&r6`*-)"
        "?k|=K<+HWDgtRfApr$N^KImPB9jn0aMv)0@6df8E+W$-{{PAYtWHO%osl8H#r`5XKtzEAJo2}}psu*<1"
        "$|x_kFNRz8H{|KkEJL0&+nbgwVaP&yCA*I2OOBCVMYk5I(m&FxTy2q3n(Ew~J90OePKohy4@|$(50oc0"
        "#_o&P!gq2r7~Zz!vI0cXb7&qUr0T7arVUh{=RGsUmZ>?E22ykK8i#aW$_LQMVJ*$XfvQGRQLZ)ahu6>t"
        "nx?MDE}*eZv_q%XU?1o#cO{iA<I!v~xSE+HQ0TVc9&A^jHwwe+Y4k9jd?vp8=)!5H)<Q=tY3Z=tC$+9x"
        "(|7MLJ3ne9yU1gaV8{2nYuqO65tZ)v?&foCwCjqB^=0iCKmoSf-Ia7z016@hM9*ndMWr94ckEK_TDHBp"
        "kvaU<6dd%hk+FgFtSPlQ+oc;4Urz=%v*>0#i6-HfVfaAyt!FGaFSy*dHLiCQjl#>iToWAAM+R_E8SQyk"
        "0O6X{O3U0iXK7@=%A61@d??s<<c3{y#OrExgVFn|&QbDeJQ{^pv*CCYjmEQR5)Q7v!vFsBUyztlCZT?m"
        "^cp$HoP%C71u>>6&_~L6*D&+;>u~h3UOP7vR|6UUKzd%)FN^v4qUzX5y<3OAtA5B3mLh*#Yfx+p&#nqK"
        ")vvvXY9Dtb(AcC8EJke&+$Emxoeb}qrlzVq8Q-Sa#{n)t-K(i07eIZmM%P7?8OJM6#QZprp9Z(L;pk%+"
        "Jq(63W2O=RFuosM4<=ttga(t@(2y*;8_YgI-+oCq-xkg<&T`K589g&!JH={s_I%O(X1jEcO3e&MqvFCd"
        "`OwhhVKSV}!Vxh*?$5+glUUp>2F$mKd2}nmZ$SRV3uZUW?!K6heHOZo(;gJtF#gylxn7<9;TpRZ(<`(0"
        "xHYr~hqtHOqWzL=IZdAiqwDd_O;p3k9wtM-6shDW4S9J&<<9I?d|NcZPwXMWEy|cFlR4~<9aRTv0%Yzm"
        "8!cM?NI|vv&Q@gmi}Lr3vg0N_Fg7)L?k-KTqAaaMj1lc(>WO8Ul{>H0+vu^PWvC^uRvMH!th`xD!yVB`"
        "?=VW{rv-;)_|I^1HJpagB)l6>W_<#`)oFA9)e(jK{{yv6x#a"
    )
...
def validate_draft(proposal, shop, prices, estimate_limit=3000):
    ...
    return {"drafts": proposal["drafts"], "estimated_cents": total}
```
...
if VISIBLE_PASSED:
    ...
    assert connected["draft"]["estimated_cents"] == 2600
...
Lucy adds lime sorbet at zero stock with a target of four and a price of 225 cents. Before coding, predict the complete accepted draft and total. Add a fresh case below. Your solution must derive it from records; a table keyed only to vanilla and strawberry will fail the instructor holdout.
...
3. How does your validator calculate 3,500 cents for the expanded shop?
...
## Extension: put a language model behind the grounded brief

Chapter 1 made exactly one model request, and the shop facts travelled inside the user message
as JSON. `read_brief` accepted one completed assistant text and refused everything else,
including tool calls. `check_brief` flagged a brief that omitted a low product or claimed an
order. `review_brief` bound the brief to the snapshot the request was built from. Every value
that mattered was calculated without the model; the model wrote prose about facts it was handed.

This closing section turns that arrangement round. The model has to *ask* for the facts through
a `stock_facts` tool, and it files its brief through a `file_brief` tool that runs the chapter's
checks before anything is written. The mechanism is the loop you will build in Chapter 3,
shipped in the embedded runtime as `agent_loop.run_loop`: send the conversation and the tool
schemas, read back an answer or tool calls, run each call through a `Dispatcher`, append the
observation under its `tool_call_id`, and ask again within `Limits`. `file_brief` is marked
consequential, so the dispatcher will not run it without a `before_write` gate, and that gate
is `check_brief`. A brief the chapter would flag never reaches the file.

The runtime adds one module, `llm_lab.py`. `ScriptedModel` replays turns written down in this
notebook, so the section runs identically for everyone; `OpenAIModel` sends the same messages
to a hosted model when a key is present. The loop cannot tell them apart; the record says which
one ran.

**Prediction:** the next cell prints the two tool schemas. Write down which tool takes no
arguments, which phrases `check_brief` refuses, and what the filed brief is bound to.
...
# The chapter's own functions: stock facts, brief checks and snapshot binding.
with contextlib.chdir(COURSE_ROOT):
    chapter_one = runpy.run_path(str(COURSE_ROOT / "book/always_on/checkpoints/ch01.py"))
SHOP = chapter_one["SHOP"]
...
class BriefArguments(NoArguments):
    brief: str = Field(min_length=20, max_length=1200)


def fresh_brief_path(label):
    """The filed brief is the only durable state here; start every run without one."""
    path = COURSE_WORK / f"ch01-b-llm-brief-{label}.json"
    path.unlink(missing_ok=True)
    return path


def build_brief_tools(shop, brief_path):
    """Two tools over the chapter's functions, bound to the snapshot at build time."""
    built = chapter_one["build"](shop)
    names = {row["sku"]: row["name"] for row in shop["products"]}
    refusals, pending = [], {"call": None}

    def facts(_):
        return [
            {"sku": sku, "name": names[sku], "on_hand": on_hand, "needed": needed}
            for sku, on_hand, needed in chapter_one["stock_facts"](shop)
        ]

    def gate(call):
        pending["call"] = call.id
        flags = chapter_one["check_brief"](call.arguments["brief"], shop)
        if flags:
            refusals.append({"call": call.id, "reason": "brief_flagged", "flags": flags})
            raise ValueError("the brief failed the chapter's checks")

    def file_brief(args):
        message = {"role": "assistant", "content": args.brief}
        document = {"choices": [{"finish_reason": "stop", "message": message}]}
        try:
            review = chapter_one["review_brief"](built, document, shop)
        except ValueError:
            refusals.append({"call": pending["call"], "reason": "snapshot_changed", "flags": []})
            raise
        write_json(brief_path, review)
        return {"status": review["status"], "flags": review["flags"], "snapshot": built["snapshot"]}

    registered = [
        ExecutableTool("stock_facts", "Read stock and calculated need.", NoArguments, facts),
        ExecutableTool(
            "file_brief",
            "File the morning brief for Lucy's review; never purchases.",
            BriefArguments,
            file_brief,
            consequential=True,
        ),
    ...
    return Dispatcher(registered, allowed=allowed, before_write=gate), refusals


scripted_brief_path = fresh_brief_path("scripted")
brief_dispatcher, brief_refusals = build_brief_tools(SHOP, scripted_brief_path)
for tool_schema in brief_dispatcher.schemas():
    function = tool_schema["function"]
    print(function["name"], "requires", function["parameters"].get("required", []))
    print("   ", function["description"])
print("Snapshot:", chapter_one["snapshot_id"](SHOP)[:16])
print("Default limits:", Limits())
BRIEF_MESSAGES = [
    {
        "role": "system",
        "content": (
            "Write a short morning stock brief for Lucy's ice cream shop. Read stock with "
            "stock_facts before writing anything and use only those facts. Name every product "
            "below its reorder point. Do not purchase anything or claim that an order exists. "
            "File the brief with file_brief, then finish with one sentence saying whether it "
            "was filed."
        ),
    },
    {"role": "user", "content": "Good morning. What does the stock look like before we open?"},
]
```

The schemas are `model_json_schema()` output wrapped in the `{"type": "function", ...}`
envelope the API expects; `required` lists the fields without defaults. `strict=True` and
`extra="forbid"` still apply, so a brief sent as a list, or a call with an extra `order` field,
is refused before any handler runs. `Limits()` is the budget the loop checks before every
attempt: model calls, tool calls, seconds, context bytes and output tokens. Chapter 3 makes you
construct that decision; here you watch it work.

### Run the loop against a recorded transcript

The turns below are what a model replied, written down. Read them as a conversation. Turn one
reads stock. Turn two files a fluent brief that also claims the supplier order has been placed:
the chapter's fluent lie, now arriving through a tool instead of a response envelope. Turn three
files a corrected brief, the same text as the chapter's offline fixture. Turn four answers with
no tool calls, which ends the loop.

**Prediction:** which call is refused, what does the model see in its place, and what does the
brief file hold afterwards? Recall that `Dispatcher.invoke` flattens every refusal to
`tool_failed`, so the gate keeps its own ledger of reasons; the transcript alone will not say
why a write was refused.


```python tags=["extension", "worked-example"]
LIE_BRIEF = (
    "Vanilla has 2 tubs and strawberry has 1, both below their reorder points. Chocolate has "
    "12 tubs. I have placed the supplier order for six vanilla and four strawberry."
)
GROUNDED_BRIEF = (
    "Vanilla has 2 tubs and strawberry has 1: both are below their reorder points. "
    "Chocolate has 12 tubs, above its reorder point. No orders have been placed."
)
RECORDED_TURNS = [
    scripted_turn(calls=[{"name": "stock_facts", "arguments": {}}]),
    scripted_turn(calls=[{"name": "file_brief", "arguments": {"brief": LIE_BRIEF}}]),
    scripted_turn(calls=[{"name": "file_brief", "arguments": {"brief": GROUNDED_BRIEF}}]),
    scripted_turn(
        "Filed the brief: vanilla and strawberry are below their reorder points, chocolate is "
        "fine, and nothing has been ordered. My first draft was refused because it claimed an "
...
scripted_result = run_loop(
    ScriptedModel(RECORDED_TURNS), brief_dispatcher, BRIEF_MESSAGES, limits=LOOP_LIMITS
)
print(describe(scripted_result, "scripted"))
print("Gate ledger:", brief_refusals)
scripted_trace = tool_trace(scripted_result)
assert scripted_result.status == "COMPLETED"
assert [step["ok"] for step in scripted_trace] == [True, False, True]
assert scripted_trace[1]["result"] == "tool_failed"
assert brief_refusals == [
    {
        "call": "scripted-2-call-1",
        "reason": "brief_flagged",
        "flags": ["possible unsupported action: placed the supplier order"],
    }
]
# The file holds the chapter's review record, bound to the snapshot the tools were built from.
filed = json.loads(scripted_brief_path.read_text(encoding="utf-8"))
print("Filed status:", filed["status"], "| flags:", filed["flags"])
assert filed["status"] == "NEEDS_FACTUAL_REVIEW" and filed["flags"] == []
assert filed["draft"] == GROUNDED_BRIEF
assert scripted_trace[2]["result"]["snapshot"] == chapter_one["snapshot_id"](SHOP)
...
The refused brief appears in the transcript as an ordinary failed observation and the loop
carries on: refusing is not crashing. The ledger names the flag; the model only saw
`tool_failed`. The file holds `NEEDS_FACTUAL_REVIEW`, the status `review_brief` gave you in
Unit A: a brief that passes every check is still a proposal for Lucy to read, not a fact.
...
receives the same two schemas and the same system message. It may read stock twice, write a
longer brief, or file more than once; what it cannot do is file a brief that omits a low product
or claims an order, because that rule lives in the gate and not in the prompt.

**Prediction:** write the brief a careful assistant should file from the stock you printed
above. Then run the cell and compare the model's brief, or the recorded one when the run is
scripted, against yours.


```python tags=["extension", "live-model"]
from sovereign_agent.llm_lab import DEFAULT_MODEL, build_model, resolve_api_key

live_brief_path = fresh_brief_path("live")
live_dispatcher, live_refusals = build_brief_tools(SHOP, live_brief_path)
...
live_result = run_loop(chosen_model, live_dispatcher, BRIEF_MESSAGES, limits=LOOP_LIMITS)
print(describe(live_result, chosen_model.source))
print("Gate ledger:", live_refusals)
live_trace = tool_trace(live_result)
assert live_result.status in {"COMPLETED", "MODEL_CALL_LIMIT", "TOOL_LIMIT", "MODEL_FAILED"}
# Whatever the model wrote, every brief that reached the file passes the chapter's checks.
filed_briefs = [step for step in live_trace if step["tool"] == "file_brief" and step["ok"]]
for step in filed_briefs:
    assert chapter_one["check_brief"](step["arguments"]["brief"], SHOP) == [], step
    assert step["result"]["snapshot"] == chapter_one["snapshot_id"](SHOP)
assert live_brief_path.exists() == bool(filed_briefs)
if filed_briefs:
    live_filed = json.loads(live_brief_path.read_text(encoding="utf-8"))
    assert live_filed["status"] == "NEEDS_FACTUAL_REVIEW" and live_filed["flags"] == []
    assert live_filed["draft"] == filed_briefs[-1]["arguments"]["brief"]
# Every refusal has a reason in the ledger, and every observation answers one request.
assert all(entry["reason"] in {"brief_flagged", "snapshot_changed"} for entry in live_refusals)
assert live_result.tool_calls == sum(1 for m in live_result.messages if m["role"] == "tool")
```

### Challenge: change the shop after the request was built

This is the chapter's transfer task, check a brief after the catalog changes, now applied to
the loop. The next cell builds the tools from a copy of `SHOP`, then restocks strawberry to six
tubs *after* the build, and replays the same recorded transcript. Predict, before running:
which of the two `file_brief` calls is refused now, by which of the chapter's functions, and
what the model's final answer claims. Then compare the answer with the file on disk.

The tools bind the request to a snapshot when they are built, exactly as `build` did in Unit A.
The gate runs `check_brief` against the current shop; the handler runs `review_brief` against
the snapshot. They can disagree, and when they do, the ledger records which one refused.

With a live key, rerun the live cell after the change and explain whether the model noticed
that its brief was refused, or reported it as filed anyway. In your notes, separate what the
scripted run proves (the loop, the gate, the snapshot binding, the transcript accounting) from
what only a live run can show (the model's judgment). The saved record keeps the two apart.


```python tags=["extension", "retained-evidence"]
changed_shop = copy.deepcopy(SHOP)
changed_brief_path = fresh_brief_path("changed")
changed_dispatcher, changed_refusals = build_brief_tools(changed_shop, changed_brief_path)
strawberry = next(row for row in changed_shop["products"] if row["sku"] == "SKU-STRAWBERRY")
strawberry["on_hand"] = 6  # restocked after the request was built
changed_result = run_loop(
    ScriptedModel(RECORDED_TURNS), changed_dispatcher, BRIEF_MESSAGES, limits=LOOP_LIMITS
)
print(describe(changed_result, "scripted, shop changed"))
print("Gate ledger:", changed_refusals)
changed_trace = tool_trace(changed_result)
assert changed_result.status == "COMPLETED"
assert [step["ok"] for step in changed_trace] == [True, False, False]
assert [entry["reason"] for entry in changed_refusals] == ["brief_flagged", "snapshot_changed"]
assert not changed_brief_path.exists()
# The recorded answer still says "filed"; the transcript and the missing file say otherwise.
assert "filed" in changed_result.answer.lower()
...
llm_lab_report = {
    ...
    "scripted": {
        ...
        "refused": [entry["reason"] for entry in brief_refusals],
        "filed": filed["draft"],
    },
    "session": {
        ...
        "refused": [entry["reason"] for entry in live_refusals],
        "filed": filed_briefs[-1]["arguments"]["brief"][:400] if filed_briefs else None,
        "answer": live_result.answer[:400],
    },
    "changed_shop": {
        "change": {"sku": "SKU-STRAWBERRY", "on_hand": 6},
        "status": changed_result.status,
        "refused": [entry["reason"] for entry in changed_refusals],
        "filed": changed_brief_path.exists(),
    },
}
llm_report_path = COURSE_WORK / "ch01-b-llm-lab-report-v1.json"
