...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/profrodai/sovereign-agent/blob/main/book/exercises/ch01/profrod-sovereign-agent-ch01-a-grounded-morning-brief-exercise.ipynb) Runs on Google Colab as it ships today, or on any local Python 3.12+ kernel.
...
def fresh_brief_path(label):
    ...
    path = COURSE_WORK / f"ch01-a-llm-brief-{label}.json"
...
llm_report_path = COURSE_WORK / "ch01-a-llm-lab-report-v1.json"
