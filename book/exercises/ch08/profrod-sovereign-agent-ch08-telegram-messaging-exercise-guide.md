...
|---|---|---|---|
| A · 90 minutes | [A: private telegram messaging](profrod-sovereign-agent-ch08-a-private-telegram-messaging-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch08-a-private-telegram-messaging-exercise.md) | Construct, connect and explain |
| B · 90 minutes | [B: messaging repair transfer](profrod-sovereign-agent-ch08-b-messaging-repair-transfer-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch08-b-messaging-repair-transfer-exercise.md) | Diagnose, repair and transfer |
