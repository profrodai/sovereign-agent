...
|---|---|---|---|
| A · 90 minutes | [A: tool isolation](profrod-sovereign-agent-ch14-a-tool-isolation-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch14-a-tool-isolation-exercise.md) | Construct, connect and explain |
| B · 90 minutes | [B: isolation repair transfer](profrod-sovereign-agent-ch14-b-isolation-repair-transfer-exercise.ipynb) | [Markdown](profrod-sovereign-agent-ch14-b-isolation-repair-transfer-exercise.md) | Diagnose, repair and transfer |
