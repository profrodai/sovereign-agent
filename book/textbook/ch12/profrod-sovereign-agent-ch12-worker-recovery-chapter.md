...
**Status: DRAFT.** Read the [textbook guide](../profrod-sovereign-agent-textbook-start-here.md) for setup and supplied-code boundaries. Practice in [Exercise Book 12](../../exercises/ch12/profrod-sovereign-agent-ch12-worker-recovery-exercise-guide.md); consult [Solutions 12](../../solutions/ch12/profrod-sovereign-agent-ch12-worker-recovery-solutions-guide.md) after attempting the work.
...
```bash
uv run python book/textbook/checkpoints/profrod_sovereign_agent_ch12_worker_recovery_checkpoint.py
uv run python book/textbook/checkpoints/profrod_sovereign_agent_ch12_worker_recovery_checkpoint.py --evidence
```
...
checkpoint = runpy.run_path(
    "book/textbook/checkpoints/profrod_sovereign_agent_ch12_worker_recovery_checkpoint.py"
)
