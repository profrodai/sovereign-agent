"""Chapter 12: replace a killed owner, then fence an old owner that is still alive."""
...
def experiment(root, *, kill):
    root.mkdir()
    supplier_context = runpy.run_path(str(Path(__file__).with_name("ch10.py")))["supplier_process"]
