"""Chapter 19: an accelerated shop day with independent supplier and worker processes."""
...
def day(root, checkpoint_dir):
    supplier_context = runpy.run_path(str(checkpoint_dir / "ch11.py"))["independent_supplier"]
...
def main():
    ...
    if not (checkpoint_dir / "ch11.py").exists():
