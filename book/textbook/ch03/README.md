...
**Status: DRAFT.** Read the [textbook guide](../README.md) for setup and supplied-code boundaries. Practice in [Exercise Book 3](../../exercises/ch03/README.md); consult [Solutions 3](../../solutions/ch03/README.md) after attempting the work.
...
Practice this chapter with the [bounded-loop practice](../../exercises/ch03/README.md). Unit A connects a learner-owned admission decision to the model/tool loop; Unit B mutates and repairs the real failed-call accounting in a temporary source copy. Solutions and holdouts remain separate from the student notebooks.
...
shop_tools = runpy.run_path("book/textbook/learner/ch02.py")
...
```bash
uv run python book/textbook/checkpoints/ch03.py --transcript
uv run python book/textbook/checkpoints/ch03.py --live --model qwen3 --transcript
