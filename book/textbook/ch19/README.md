...
**Status: DRAFT.** Read the [textbook guide](../README.md) for setup and supplied-code boundaries. Practice in [Exercise Book 19](../../exercises/ch19/README.md); consult [Solutions 19](../../solutions/ch19/README.md) after attempting the work.
...
```bash
uv run --python 3.14 python book/textbook/checkpoints/ch19.py --output /tmp/lucy-day-proof-1
```
