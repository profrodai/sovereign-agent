...
**Status: DRAFT.** Read the [textbook guide](../profrod-sovereign-agent-textbook-start-here.md) for setup and supplied-code boundaries. Practice in [Exercise Book 19](../../exercises/ch19/profrod-sovereign-agent-ch19-integrated-shop-day-exercise-guide.md); consult [Solutions 19](../../solutions/ch19/profrod-sovereign-agent-ch19-integrated-shop-day-solutions-guide.md) after attempting the work.
...
```bash
uv run --python 3.14 python book/textbook/checkpoints/profrod_sovereign_agent_ch19_integrated_shop_day_checkpoint.py --output /tmp/lucy-day-proof-1
```
