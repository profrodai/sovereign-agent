...
**Status: DRAFT.** Read the [textbook guide](../README.md) for setup and supplied-code boundaries. Practice in [Exercise Book 10](../../exercises/ch10/README.md); consult [Solutions 10](../../solutions/ch10/README.md) after attempting the work.
