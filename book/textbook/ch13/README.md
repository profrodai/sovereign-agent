...
This chapter follows [worker recovery](../ch12/README.md) and precedes [tool isolation](../ch14/README.md). MCP supplies a protocol boundary; the next chapter supplies a separately configured operating-system boundary. Starting an MCP child executable does not sandbox it.
...
Continue to [Chapter 14: isolation](../ch14/README.md). [Exercise Book](../../exercises/ch13/README.md) · [Solutions Book](../../solutions/ch13/README.md) · [Textbook contents](../README.md).
