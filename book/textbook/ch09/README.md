...
**Status: DRAFT.** Read the [textbook guide](../README.md) for setup and supplied-code boundaries. Practice in [Exercise Book 9](../../exercises/ch09/README.md); consult [Solutions 9](../../solutions/ch09/README.md) after attempting the work.
...
```bash
uv run python book/textbook/checkpoints/ch09.py
uv run python book/textbook/checkpoints/ch09.py --live --model qwen3 --transcript
```
