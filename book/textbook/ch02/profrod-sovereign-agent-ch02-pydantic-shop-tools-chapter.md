...
**Status: DRAFT.** Read the [textbook guide](../profrod-sovereign-agent-textbook-start-here.md) for setup and supplied-code boundaries. Practice in [Exercise Book 2](../../exercises/ch02/profrod-sovereign-agent-ch02-pydantic-shop-tools-exercise-guide.md); consult [Solutions 2](../../solutions/ch02/profrod-sovereign-agent-ch02-pydantic-shop-tools-solutions-guide.md) after attempting the work.
...
SHOP = runpy.run_path(
    "book/textbook/checkpoints/profrod_sovereign_agent_ch01_first_model_call_checkpoint.py"
)["SHOP"]
...
The standalone checkpoint collects the fixture and shop functions in `book/textbook/checkpoints/profrod_sovereign_agent_ch02_pydantic_shop_tools_checkpoint.py`. It imports the small request and dispatcher classes whose implementation you have just built from the cumulative source tree. These are this book's own components, and their complete execution path appears above. There is no hidden agent framework selecting or running tools.
...
```bash
uv run python book/textbook/checkpoints/profrod_sovereign_agent_ch02_pydantic_shop_tools_checkpoint.py
