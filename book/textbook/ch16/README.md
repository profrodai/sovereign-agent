...
**Status: DRAFT.** Read the [textbook guide](../README.md) for setup and supplied-code boundaries. Practice in [Exercise Book 16](../../exercises/ch16/README.md); consult [Solutions 16](../../solutions/ch16/README.md) after attempting the work.
...
original = tomllib.loads(Path("book/textbook/skills/opening-check-v1.toml").read_text())
