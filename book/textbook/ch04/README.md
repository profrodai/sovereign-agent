...
This chapter sits between the [model/tool loop](../ch03/README.md) and [memory](../ch05/README.md). It constructs the state boundary that the rest of the book will consume. A small SQLite database is the first useful mechanism; copying the finished project's complete historical schema would hide the design we need to understand.
...
Continue to [Chapter 5: memory](../ch05/README.md). [Exercise Book](../../exercises/ch04/README.md) · [Solutions Book](../../solutions/ch04/README.md) · [Textbook contents](../README.md).
