...
**Status: DRAFT.** Read the [textbook guide](../profrod-sovereign-agent-textbook-start-here.md) for setup and supplied-code boundaries. Practice in [Exercise Book 17](../../exercises/ch17/profrod-sovereign-agent-ch17-bounded-delegation-exercise-guide.md); consult [Solutions 17](../../solutions/ch17/profrod-sovereign-agent-ch17-bounded-delegation-solutions-guide.md) after attempting the work.
