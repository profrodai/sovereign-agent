...
source = Path("book/textbook/skills/profrod_sovereign_agent_textbook_opening_check_v1.toml")
...
checkpoint = runpy.run_path(
    "book/textbook/checkpoints/profrod_sovereign_agent_ch06_versioned_skills_checkpoint.py"
)
...
```bash
uv run python book/textbook/checkpoints/profrod_sovereign_agent_ch06_versioned_skills_checkpoint.py --live --model qwen3 --transcript
```
