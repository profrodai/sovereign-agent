...
This chapter follows [tested skills](../ch06/README.md) and precedes [Telegram](../ch08/README.md). We first build the shared work mechanism without a messaging account. Telegram and the scheduler then become producers for that mechanism rather than separate agents.
...
Continue to [Chapter 8: Telegram](../ch08/README.md). [Exercise Book](../../exercises/ch07/README.md) · [Solutions Book](../../solutions/ch07/README.md) · [Textbook contents](../README.md).
